...
class AdminUI extends AdminUI_general
{
	...
	{
		global $app_shortname, $app_version, $current_User, $htsrv_url_sensible, $baseurl, $admin_url, $rsc_url, $Blog;
		...
		<div id="header">
			...
			<div id="headinfo">
				...
				.'<a href="'.$htsrv_url_sensible.'login.php?action=logout&amp;redirect_to='.$admin_url.'">'.T_('Logout').'</a>
					&bull;
