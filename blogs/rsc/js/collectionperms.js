...
function merge_from_easy( source, userid )
{
	...
	switch( source.value )
	{
		...
		case 'moderator':
			source.form.elements['blog_perm_own_cmts_'+String(userid)].checked = 1;
			source.form.elements['blog_perm_vote_spam_cmts_'+String(userid)].checked = 1;
...
function merge_from_wide( source, userid )
{
	...
	else
	{
		...
		var perm_moderator = Number(f.elements['blog_perm_redirected_'+String(userid)].checked)
										+Number(f.elements['blog_perm_own_cmts_'+String(userid)].checked)
										+Number(f.elements['blog_perm_vote_spam_cmts_'+String(userid)].checked)
