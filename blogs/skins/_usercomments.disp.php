...
$params = array_merge( array(
		...
		'user_commentlist_no_results' => T_('User has no posted comments'),
		'user_commentlist_col_post'   => T_('Comment on:'),
	), $params );


$user_CommentList->title = sprintf( $params['user_commentlist_title'], $viewed_User->get_identity_link( array( 'link_text' => 'link' ) ) );
