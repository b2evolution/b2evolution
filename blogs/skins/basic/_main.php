...
<?php
  ...
  <small><?php $Blog->disp( 'longdesc', 'htmlbody' ); ?></small>
	...
	if( isset($MainList) ) while( $Item = $MainList->get_item() )
	{
		...
		<h3>
			<?php $Item->issue_time(); ?>
			<a href="<?php $Item->permalink() ?>" title="<?php echo T_('Permanent link to full entry') ?>"><img src="img/icon_minipost.gif" alt="Permalink" width="12" height="9" align="middle" /></a>
			<?php $Item->title(); ?>
			&nbsp;
	...
	<div align="center">Powered by <a href="http://b2evolution.net/" title="b2evolution home"><img src="../../img/b2evolution_button.png" alt="b2evolution" width="80" height="15" align="middle" /></a> <!-- Please help us promote b2evolution and leave this link on your blog. --></div>
	<?php
