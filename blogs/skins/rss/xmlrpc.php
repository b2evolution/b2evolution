 ...
 */
require_once($core_root.'/../conf/_config.php' );
require_once($core_root.'/'.$xmlsrv_dirout.$core_subdir.'_main.inc.php' );
...
function logIO($io,$msg)
{
	...
	if ($xmlrpc_logging)
	{
		$fp = fopen( $core_root.'/xmlrpc.log',"a+");
...
/*
 * $Log$
 * Revision 1.1  2005/10/18 13:05:16  marian
 * added the missing directory /skins/rss
 *
