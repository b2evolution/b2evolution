...
class Item extends ItemLight
{
	 ...
	 * updated.
	 *
	 * @internal Tblue> Problem with this: An user can update the
	 *                  excerpt without updating the datemodified field.
	 *                  While this is intended when the autogenerated
	 *                  excerpt gets updated, it probably isn't for a
	 *                  manual update.
	 * 
	 * @var array
