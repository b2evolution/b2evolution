...
class Item extends ItemLight
{
	               ...
	               $creator_field = 'creator_user_ID', $lasteditor_field = 'lastedit_user_ID' )
	{
		...
		else
		{
			...
			$this->hideteaser = $db_row->post_hideteaser;
			for( $i = 1 ; $i <= 5; $i++ )
			{
	...
	function load_from_Request( $editing = false, $creating = false )
	{
		...
		$this->set( 'hideteaser', param( 'item_hideteaser', 'integer', 0 ), false );
	...
	function get_content_teaser( $disppage = '#', $stripteaser = '#', $format = 'htmlbody' )
	{
		...
		{ // This is an extended post (has a more section):
			if( $stripteaser === '#' )
			{
				...
				$stripteaser = ( $more && $this->hideteaser );
			}
...
/*
 * $Log$
 * Revision 1.243  2011/09/17 02:32:00  fplanque
 * Unless I screwed up with merges, this update is for making all included files in a blog use the same domain as that blog.
 *
 * Revision 1.242  2011/09/08 23:29:27  fplanque
 * More blockcache/widget fixes around login/register links.
 *
 * Revision 1.241  2011/09/08 05:22:40  efy-asimo
 ...
 *
 * Revision 1.202  2010/05/14 21:42:47  blueyed
