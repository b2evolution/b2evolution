...
class Item extends ItemLight
{
	...
	/**
	 * Has the item excerpt been autogenerated?
	 *
	 * @var boolean
	 * @access private
	 */
	var $excerpt_autogen = false;
	...
	function dbupdate()
	{
		...
		$update_datemodified = ( ! $this->excerpt_autogen || count( $this->dbchanges ) != 1 );
		if( $result = parent::dbupdate( $update_datemodified ) )
...
/*
 * $Log$
 * Revision 1.122  2009/07/18 16:56:38  tblue246
 * a) Minor/doc; b) Remove unneeded check
 *
 * Revision 1.121  2009/07/18 16:30:15  tblue246
 * Better solution for preventing an update of the datemodified field when the excerpt gets autogenerated.
 *
 * Revision 1.120  2009/07/17 23:11:11  tblue246
 ...
 *
 * Revision 1.119  2009/07/17 20:13:42  tblue246
 * doc
 *
