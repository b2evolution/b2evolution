...
class Item extends ItemLight
{
	 ...
	 *       dh> this is available now, isn't it?
	 * @todo dh> Merge this and get_content_teaser with excerpt handling. Or isn't it considered to be the same?!
	 *           I mean, excerpt should probably default to what get_content_teaser does currently?
	 */
