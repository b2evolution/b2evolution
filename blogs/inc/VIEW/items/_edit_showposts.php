...
echo '<div class="NavBar">';
	...
	request_title( '<h2>', '</h2>', '<br />', 'htmlbody', true, true, $dispatcher.'?ctrl=browse', 'blog='.$blog );
...
while( $Item = $MainList->get_item() )
{
	...
	<div class="bPost bPost<?php $Item->status( 'raw' ) ?>" lang="<?php $Item->lang() ?>">
		...
		<div class="PostActionsArea">
			...
			{
 				echo '<a href="?ctrl=browse&amp;tab=posts&amp;blog='.$blog.'&amp;p='.$Item->ID.'&amp;c=1" class="ActionButton">';
