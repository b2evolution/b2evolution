...
$Form->begin_fieldset( T_('Preferences') );
	...
	{ // We can edit the values:
	  ...
	  // fp> TODO: We gotta have something like $edited_User->UserSettings->get('legend');
		...
		$Form->checkbox( 'edited_user_admin_toolbar', $UserSettings->get( 'admin_toolbar', $edited_User->ID ), T_('Display admin toolbar'), T_('Display an administration toolbar on top of the skin.') );
...
/*
 * $Log$
 * Revision 1.10  2009/03/18 15:20:58  tblue246
