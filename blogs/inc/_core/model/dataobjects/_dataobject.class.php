...
class DataObject
{
	 ...
	 *
	 * @param boolean False to prevent updating the datemodified field.
	 * @return boolean true on success, false on failure to update, NULL if no update necessary
	 */
	function dbupdate( $update_datemodified = true )
	{
		...
		if( !empty($this->datemodified_field) && $update_datemodified )
