 ...
 * @version $Id$
 *
 * @todo KILL THIS CLASS!!! It is useless and has no clear boundaries. Most of what's in here should be directly in files.php
 * @todo Permissions!
 * @todo Performance
...
class FileManager extends Filelist
{
	...
	{
		global $basepath, $baseurl, $media_subdir, $admin_subdir;
...
fp>> STOP adding features to this lousy Fileman class. All this should be direclty in files.php
	 *
