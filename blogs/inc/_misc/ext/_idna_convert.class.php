...
class idna_convert
{
    ...
    function idna_convert($options = false)
    {
        ...
        if (function_exists('file_get_contents')) {
            $this->_np_ = unserialize(file_get_contents(dirname(__FILE__).'/_idna_convert_npdata.ser.inc'));
        } else {
            $this->_np_ = unserialize(join('', file(dirname(__FILE__).'/_idna_convert_npdata.ser.inc')));
        }
