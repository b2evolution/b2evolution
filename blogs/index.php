...
// M.H.
if (file_exists('./_domain_conf.inc.php'))
{
    require_once '_domain_conf.inc.php';
} else {
    $core_root = dirname(__FILE__);
}


require_once $core_root.'/evocore/_main.inc.php';
...
require( $core_root .'/'.$core_subdir.'_blog_main.inc.php' );
