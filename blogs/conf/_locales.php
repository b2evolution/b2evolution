...
$locales = array(
	...
	'de-DE' => array(	'name' => NT_('German (Germany)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'd.m.y',
										'timefmt' => 'H:i:s',
										'messages' => 'de_DE',
	...
	'en-US' => array( 'name' => NT_('English (USA)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'm/d/y',
										'timefmt' => 'h:i:s a',
										'messages' => 'en_US',
	...
	'es-ES' => array(	'name' => NT_('Spanish (Spain)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'd.m.y',
										'timefmt' => 'H:i:s',
										'messages' => 'es_ES',
	...
	'fr-FR' => array(	'name' => NT_('French (France)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'd.m.y',
										'timefmt' => 'H:i:s',
										'messages' => 'fr_FR',
	...
	'it-IT' => array(	'name' => NT_('Italian (Italy)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'd.m.y',
										'timefmt' => 'H:i:s',
										'messages' => 'it_IT',
	...
	'ja-JP' => array(	'name' => NT_('Japanese (Japan)'),
										'charset' => 'utf-8',
										'datefmt' => 'Y/m/d',
										'timefmt' => 'H:i:s',
										'messages' => 'ja_JP',
	...
	'nb-NO' => array( 'name' => NT_('Bokm&aring;l (Norway)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'd.m.y',
										'timefmt' => 'H:i:s',
										'messages' => 'nb_NO',
	...
	'nl-NL' => array(	'name' => NT_('Dutch (Netherlands)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'd-m-y',
										'timefmt' => 'H:i:s',
										'messages' => 'nl_NL',
	...
	'pt-BR' => array(	'name' => NT_('Portuguese (Brazil)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'd.m.y',
										'timefmt' => 'H:i:s',
										'messages' => 'pt_BR',
	...
	'sv-SE' => array(	'name' => NT_('Swedish (Sweden)'),
										'charset' => 'iso-8859-1',
										'datefmt' => 'y-m-d',
										'timefmt' => 'H:i:s',
										'messages' => 'sv_SE',
