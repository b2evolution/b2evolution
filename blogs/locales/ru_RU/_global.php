...
$trans['ru_RU'] = array(
	...
	'How many days or posts fo you want to display on the home page?' => "Как много дней или записей вы хотите показывать на домашней странице?",
	...
	'Use excerpt as meta description for posts and pages' => "Использовать выдержку в мета тегах \"description\" для записей и страниц",
	...
	'You can come back here at any time by clicking "Manage" in that same evobar.' => "Вы можете вернуться сюда в любое время нажав \"Панель управления\" на той же панели.",
	...
	'The value is invalid. It must be smaller than %s.' => "Значение недопустимо. Оно должно быть меньше %s.",
	'The value is invalid. It must be greater than %s.' => "Значение недопустимо. Оно должно быть больше %s.",
	...
	'Base config recap...' => "Вернуть основную конфигурацию...",
	'If you don\'t see correct settings here, STOP before going any further, and <a %s>update your base configuration</a>.' => "Если вы видите здесь неправильные настройки, не двигайтесь дальше, а <a %s>измените вашу основную конфигурацию</a>.",
	...
	'Base configuration' => "Основная конфигурация",
	...
	'This is the minimum info we need to set up b2evolution on this server:' => "Это минимальное количество информации, необходимой для установки b2evolution на этот сервер:",
	'Database you want to install into' => "База данных, в которую вы хотите установить",
	...
	'<strong>Change your base configuration</strong> (see recap below): You only want to do this in rare occasions where you may have moved your b2evolution files or database to a different location...' => "<strong>Измените ваши начальные настройки</strong>: Вам необходимо будет это делать лишь в том случае, когда вы хотите переместить файлы b2evolution или базу данных в другое место...",
	...
	'Upgrading data in existing b2evolution database...' => "Обновление записей существующей базы данных b2evolution...",
	...
	'Automatic &lt;P&gt; and &lt;BR&gt; tags' => "Автоматические теги &lt;P&gt; и &lt;BR&gt;",
	...
	'Ping b2evolution.net' => "Пинговать b2evolution.net",
	'Ping the b2evolution.net site' => "Пинговать сайт b2evolution.net",
	...
	'Advanced paste support' => "Дополнительные свойства",
	...
	'Show XHTML Extras' => "Разрешенные XHTML теги",
