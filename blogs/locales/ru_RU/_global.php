...
'Cache directory could not be accessed.' => 'Нет доступа к папке кэша.',
...
'URL' => 'URL',
'No %s match the keyword [%s]' => 'Нет %s, содержащих ключевое слово [%s]',
'The keyword [%s] is %s by the blacklist.' => 'Ключевое слово [%s] %s в черном списке.',
...
'New users automatically get a new blog' => 'Новые пользователи автоматически получают личный блог',
...
'Edit<br />commts' => 'Редакт.<br />коммент.',
'Permission to edit draft comments in this blog' => 'Разрешение редактировать комментарии со статусом "черновик"',
...
'Couldn\'t replace the old version' => 'Не удалось заменить старую версию',
'The old version has been replaced!' => 'Старая версия была заменена!',
...
'Replace the old version %s with the new version %s' => 'Заменить старую версию %s новым файлом %s',
'Don\'t touch the old version. Keep 2 separate versions.' => 'Сохранить старую версию и оставить 2 файла.',
...
'Allow cross posting post to several blogs' => 'Разрешить размещение записей в нескольких блогах одновременно',
