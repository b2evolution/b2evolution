...
'Send an Email Message' => 'Отправка сообщений',
...
'The keyword [%s] is already handled by the blacklist.' => 'Ключевое слово [%s] уже находится в черном списке.',
'Blacklist the keyword [%s] locally.' => 'Добавить ключевое слово [%s] в локальный черный список.',
'Report the keyword [%s] as abuse to b2evolution.net.' => 'Отправить слово [%s] в черный список b2evolution.net.',
...
'New user automatically get a new blog' => 'Новые пользователи автоматически получают персональный блог',
...
'Edit<br />comts' => 'Ред.<br />комм.',
'Permission to edit comments in this blog' => 'Разрешение редактировать комментарии в этом блоге',
...
'Installed version doesn\'t support upgrade!' => 'Установленная версия не поддерживает обновление!',
...
'You don\'t have permission to send private message.' => 'У вас нет разрешений на отправку личных сообщений.',
...
'Recreate all item slugs. Old slugs will still work, but redirect to the new one.' => 'Обновить короткие ссылки. Старые ссылки будут перенаправлены на новые и останутся рабочими.',
...
'You can upload your own fonts to the plugin font directory (%s), then use the filename here. By default "%s" is used.' => 'Вы можете загрузить собственные шрифты в папку (%s), после чего вставить имя файла сюда. По умолчанию используется шрифт "%s".',
...
'This user only accepts private messages but you are not allowed to send any private messages.' => 'Этот пользователь принимает только личные сообщения, но у вас нет разрешений на их отправку.',
