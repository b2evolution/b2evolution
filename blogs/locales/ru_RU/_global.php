...
'Page caching has been enabled for this blog.' => 'Кэширование было включено для этого блога.',
'Page caching could not be enabled for this blog. Check /cache/ folder file permissions.' => 'Кэширование не может быть включено для этого блога. Проверьте разрешения на папку /cache/.',
'Page caching has been disabled for this blog. All cache contents have been purged.' => 'Кэширование было отключено для этого блога. Весь кэш удален.',
...
'This is displayed under the blog name on the blog template.' => 'Будет показан под именем блога в вашей теме.',
...
'%d linked users (avatars)' => '%d связанных пользователей (аватар)',
...
'Could not retrieve file. Error: %s (status %s). Used method: %s.' => 'Не удалось получить файл. Ошибка: %s (статус %s). Метод передачи: %s.',
...
'Link this image to your post' => 'Добавить эту картинку к вашей записи',
'recommended - allows automatic resizing' => 'рекомендуется - автоматическое изменение размера',
'Link this file to your post' => 'Добавить этот файл к вашей записи',
'The file will be appended for download at the end of the post' => 'Файл будет приложен для скачивания в конце записи',
'Link this file!' => 'Привязать этот файл!',
'or' => 'или',
'Insert the following code snippet into your post' => 'Вставить следующий код в вашу запись',
'You can only set an image file to avatar!' => 'В качестве аватара можно назначить только картинку!',
...
'Use this as an avatar image!' => 'Использовать файл в качестве аватара!',
'Edit permissions' => 'Редактировать разрешения',
'Edit file...' => 'Редактировать файл...',
'No files found.' => 'Файлы не найдены.',
'Link files to current post' => 'Привязать файлы к текущей записи',
...
'Mime type' => 'Тип Mime',
'File name of the icon, must be in %s.' => 'Имя файла иконки, должна находиться в %s.',
'Icon' => 'Иконка',
...
'Warning: the URL slug has been changed to &laquo;%s&raquo;.' => 'Внимание: короткая ссылка записи была изменена на &laquo;%s&raquo;.',
...
'Messaging' => 'Сообщения',
'Reply to people you have messaged with in the past' => 'Отвечать людям, с которыми вы раньше переписывались',
'Create threads, view any thread you\'re involved in & reply' => 'Создавать переписки, а также просматривать любые переписки в которых вы участвовали',
'Create threads, view and delete any thread you\'re involved in & reply' => 'Создавать переписки, а также просматривать и удалять любые переписки в которых вы участвовали',
'Contacts' => 'Контакты',
'Thread' => 'Темы',
'Message' => 'Сообщение',
...
'has created the "%s" conversation. ' => 'создал переписку "%s". ',
'To read it, click on this link: %s' => 'Нажмите, чтобы прочесть: %s',
'New message in conversation "%s" created' => 'Создано новое сообщеие в переписке "%s"',
'has created a new message in the "%s" conversation. ' => 'добавил новое сообщение в переписку "%s". ',
'Best regards' => 'С наилучшими пожеланиями',
'%s mailer' => 'Отправитель: %s',
...
'Enter comma or space separated logins' => 'Ввидите логины, разделенные пробелом или запятой',
'Recipients' => 'Адресаты',
'Subject' => 'Тема',
...
'The currency is enabled.' => 'Эта валюта включена.',
'The currency is disabled.' => 'Эта валюта отключена.',
...
'Have you waited more than 2 hours before submitting your request?' => 'Судя по всему, прошло более двух часов с момента открытия этой страницы до отправки запроса.',
...
'GD FreeType Support' => 'Поддержка FreeType в GD',
...
'Create sample posts for testing moderation' => 'Создать записи для тестирования',
...
'The user has %d authored message(s)' => 'У пользователя %d сообщений',
...
'Could not change the avatar!' => 'Не удалось изменить аватар!',
'Avatar has been set successfull.' => 'Аватар был назначен.',
...
'Allow users to upload avatars.' => 'Разрешить пользователям загружать аватары.',
...
'Edit %s avatar' => 'Выбор аватара для %s',
'Remove' => 'Удалить',
'Change' => 'Изменить',
...
'Select a previously uploaded avatar' => 'Выберите загруженный ранее аватар',
'View %s personal blogs' => 'Личные блоги %s',
'You have no personal blogs yet' => 'На данный момент у вас нет личных блогов',
'Edit user identity' => 'Редактирование профиля пользователя',
'Edit %s identity' => 'Редактирование профиля %s',
...
'Allow others to send me private messages' => 'Получать личные сообщения',
'Allow others to send me emails through a message form (email address will never be displayed)' => 'Получать сообщения пользователей через контактную форму (email не отображается)',
...
'Instant Messaging' => 'Мгновенное сообщение',
'Phone' => 'Телефон',
'Web' => 'Сайт',
...
'Unconfirmed email' => 'Неподтвержденный email',
...
'use custom duration' => 'назначить длительность',
...
'Shows how many users like the corresponding content.' => 'Показывает скольким пользователям нравится текущая запись или страница сайта.',
...
'Disable anonymous URLs' => 'Запретить URLы посетителей',
'Disable URLs from non-registered visitors.' => 'Запретить незарегистрированным посетителям оставлять URL адрес в комментариях.',
...
'Could not initialize' => 'Не удалось инициализировать',
...
'Error occured during twitter plugin initialization. Pleas try again.' => 'Твиттер: произошла ошибка при инициализации плагина. Повторите попытку.',
'Error occured during verifying twitter plugin initialization. Pleas try again.' => 'Твиттер: произошла ошибка в процессе проверки плагина. Повторите попытку.',
'Twitter plugin connection denied.' => 'Твиттер: соединение запрещено.',
'Twitter plugin was initialized successful!' => 'Твиттер: плагин успешно запущен!',
'Twitter account have been unlinked' => 'Твиттер: разорвана привязка к аккаунту',
...
'The function imagettftext() is not available.' => 'Функция imagettftext() недоступна.',
...
'Log in!' => 'Войти!',
'Standard login form' => 'Форма входа',
...
'Subject of private message.' => 'Тема личного сообщения.',
