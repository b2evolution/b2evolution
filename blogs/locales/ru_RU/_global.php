...
'Blog skin settings' => 'Настройки темы блога',
...
'Root' => 'Корень',
'New category created.' => 'Создана новая категория.',
...
'Put the site into maintenance mode while backing up (recommended).' => 'Ввести сайт в Служебный режим на время резервного копирования (рекомендуется).',
...
'Using an opcode cache allows all your PHP scripts to run faster by caching a "compiled" (opcode) verison of the scripts instead of recompiling everything at every page load. Several opcode caches are available. We recommend APC.' => 'Использование opcode кэша позволяет PHP скриптам запускаться быстрее за счет кэширования обработанного кода скриптов. Существует несколько программ opcode кэширования. Мы рекомендуем APC.',
...
'Clear thumbnail caches (.evocache directories)' => 'Удалить кэш миниатюр (папки .evocache)',
...
'You already have a file named .htaccess at your base url.' => 'У вас уже есть файл именем .htaccess в корне блога.',
'Can not find file ' => 'Не удалось найти файл ',
'Failed to copy files!' => 'Не удалось скопировать файлы!',
'install/test/index.html was changed' => 'Файл install/test/index.html был изменен',
'Test was successful, but failed to copy files!' => 'Тест прошел успешно, но файлы скопировать не удалось!',
...
'Error occured during installation .htaccess:' => 'Ошибка при установке файла .htaccess:',
