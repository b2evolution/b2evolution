...
'Use excerpt as meta description for posts and pages' => 'Использовать выдержку в мета тегах "description" для записей типов "Post" и "Page"',
...
'KB. This cannot be higher than your PHP/Webserver setting and the limit of %s (in %s), which is currently %s!' => 'KB. Это не может быть выше чем задано в настройках PHP/Сервера и ограничено %s (в %s), что в данный момент равно %s!',
...
'b2evolution tips category &ndash; Sub Intro post' => 'Сатегория "советы по b2evolution" &ndash; это Sub Intro запись',
