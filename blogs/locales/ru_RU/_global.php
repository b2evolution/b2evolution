...
'log-hits' => 'хитов',
'Delete the following %s %s:' => 'Удалить следующие %s %s:',
'referer hits' => 'хитов рефереров',
'Referer' => 'Реферер',
'Ref. IP' => 'IP реферера',
'Target Blog' => 'Целевой блог',
'Target URL' => 'Целевой URL',
'comments' => 'комментариев',
'There are %d matching %s but you have no permission to see them.' => 'Найдено %d %s, однако, у вас нет прав на их просмотр.',
'users' => 'пользователей',
...
'Nickname' => 'Ник',
'URL' => 'URL',
'No %s match the keyword [%s]' => 'Нет %s, содержащих ключевое слово [%s]',
'already handled' => 'уже есть',
...
'The url name is invalid.' => 'Недопустимая короткая ссылка.',
'This URL name is already in use by another blog. Please choose another name.' => 'Такая короткая ссылка уже используется другим блогом. Пожалуйста, выберите другую.',
...
'Edit screen' => 'Страница редактирования',
