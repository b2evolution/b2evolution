...
'If you have no account yet, you can <a href="%s">register now</a>... (It only takes a few seconds!)' => 'Если у вас еще нет аккаунта, вы можете <a href="%s">зарегистрироваться</a>... (Это займет всего несколько секунд!)',
...
'Uploading' => 'Загружаем...',
'Your browser does not support XMLHttpRequest technology! Please use the standard upload instead.' => 'Ваш браузер не поддерживает метод XMLHttpRequest! Используйте стандартную форму загрузки.',
