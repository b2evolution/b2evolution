...
$trans['ru_RU'] = array(
	...
	'<strong>Note:</strong> Ordering of categories is currently set to %s in the %sglobal settings%s.' => "<strong>Примечание:</strong> В %sобщих настройках%s в настоящее время активирована %s сортировка рубрик.",
	...
	'Default ordering of posts.' => "Сортировка записей по умолчанию.",
	...
	'How many days or posts do you want to display on the home page?' => "Как много дней или записей вы хотите показывать на домашней странице?",
	...
	'No links on titles' => "Не связывать с заголовками",
	...
	'Ord' => "Сортировать",
	'i' => "инфо",
	'Edit linked files...' => "Редактировать прикрепленные файлы...",
	'New page' => "Новая страница",
	...
	'Ordering of categories' => "Упорядочивание рубрик",
	...
	'Post to your Twitter account when you post to your blog' => "Дублировать на Twitter записи, созданные вами в блоге",
