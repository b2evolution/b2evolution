...
'You don\'t have permission to upload!' => 'У вас нет разрешений на загрузку!',
'Your profile picture has been set.' => 'Ваше фото было создано.',
...
'By replying to this message, your email will go directly to %s' => 'При ответе на это письмо ваш email будет адресован %s',
...
'Account email validation' => 'Подтверждение email адреса',
...
'You must validate your email address before you can continue as a logged in user.' => 'Вы должны подтвердить свой email адрес перед тем как сможете авторизоваться.',
...
'Replacement tags: %s.' => 'Возможные теги: %s.',
...
'Allow ratings from' => 'Оценка комментариев',
...
'Ability to edit timestamp on posts and comments in this blog' => 'Разрешить изменять время публикации записей и комментариев в этом блоге',
...
'Send notifications about &laquo;%s&raquo; new comment' => 'Отправка уведомлений о новом комментарии на запись &laquo;%s&raquo;',
'Hello %s !' => 'Привет %s !',
...
'If you have no account yet, you can %s (It only takes a few seconds)' => 'Если у вас еще нет аккаунта, вы можете %s (Это займет всего несколько секунд)',
...
'Empty all blog\'s recycle bin' => 'Очистить корзины всех блогов',
...
'Uploading' => 'Загружаем...',
'Your browser does not support XMLHttpRequest technology! Please use standard upload!' => 'Ваш браузер не поддерживает метод XMLHttpRequest! Используйте стандартную форму загрузки!',
'The file is too large: %1 but the maximum allowed is %2.' => 'Файл слишком большой: %1, а разрешено максимум %2.',
'OK' => 'OK',
...
'There is one comment on this post but you must be logged in to see the comments.' => 'У этой записи есть один комментарий, авторизуйтесь чтобы его открыть.',
'There are %s comments on this post but you must be logged in to see the comments.' => 'У этой записи %s комментариев, авторизуйтесь, чтобы их открыть.',
...
'Edit advanced preferences for user %s' => 'Редактирование дополнительных настроек пользователя %s',
...
'Edit profile picture for user %s' => 'Редактирование фото пользователя %s',
...
'View personal blogs for user %s' => 'Просмотр личных блогов пользователя %s',
'You have no personal blogs yet' => 'На данный момент у вас нет личных блогов',
'Edit user profile' => 'Изменить профиль пользователя',
'Edit profile for user %s' => 'Редактирование профиля пользователя %s',
...
'Notify me by email whenever a comment is awaiting moderation on one of <strong>my</strong> blogs.' => 'Отправлять уведомления о комментариях в <strong>моих</strong> блогах, ожидающих модерации.',
...
'Change password for user %s' => 'Редактирование пароля пользователя %s',
'Change password!' => 'Изменить пароль!',
'Abandon password change' => 'Отменить изменение пароля',
'Edit preferences for user %s' => 'Редактирование настроек пользователя %s',
...
'Continue' => 'Продолжить',
'An email has just been sent to %s . Please check your email and click on the validation link you will find in that email.' => 'На ваш адрес %s было отправлено письмо. Пожалуйста, нажмите на ссылку в нем для подтверждения вашего аккаунта.',
'If you have not received the email in the next few minutes, please check your spam folder. The email was sent from %s and has the title &laquo;%s&raquo;.' => 'Если по прошествии нескольких минут вы все еще не получили письмо, пожалуйста проверьте папку для спама. Письмо было отправлено от %s с заголовком &laquo;%s&raquo;.',
'If you still can\'t find the email or if you would like to try with a different email address,' => 'Если вы не смогли найти письмо или же хотите изменить email адрес,',
'click here to try again' => 'отправить еще раз',
