...
$trans['de_DE'] = array(
	...
	'You sould check the permission for [%s]. See <a %s>online manual on file permissions</a>.' => "Du solltest die Dateirechte von [%s] überprüfen. Siehe <a %s>Onlineanleitung über Dateirechte</a>.",
	...
	'Could not load original conf file [%s]. Is it missing?' => "Konnte die ursprüngliche Konfigurationsdatei [%s] nicht laden. Fehlt sie?",
	...
	'Your config file has not been edited yet. You can do this by filling in the form below.' => "Deine Konfigurationsdatei wurde noch nicht editiert. Du kannst das durch Ausfüllen des unteren Formulars machen.",
	...
	'Database you want to install into (These settings should be provided by your host)' => "Datenbank in die du installieren möchtest (Diese Einstellungen sollten von deinem Host bereitgestellt werden)",
