...
'Passwords cannot contain the characters &lt;, &gt; and &amp;.' => 'Passwörter dürfen die folgenden Zeichen nicht enthalten: <, > and &.',
...
'You need to log in before you can access this collection.' => 'Sie müssen sich einloggen, bevor Sie auf diese Sammlung zugreifen können.',
...
'A blog optimized for publishing photos.' => 'Ein für das Veröffentlichen von Fotos optimierter Blog.',
...
'Collection stats' => 'Sammlungsstatistiken',
'Web posts' => 'Web-Einträge',
'XMLRPC posts' => 'XMLRPC Einträge',
'Email posts' => 'E-Mail-Einträge',
'Files' => 'Dateien',
...
'%d user post read statuses' => '%d von Benutzern eingetragene Status',
...
'Short time format cannot be empty.' => 'Kurzes Zeitformat kann nicht leer sein.',
...
'We cannot reload the locale %s because the file %s was not found.' => 'Die Sprache mit der Codierung %s kann nicht geladen werden, da die Datei %s nicht gefunden wurde.',
...
'Send delete info PM' => 'Private Nachricht über Löschung senden',
...
'%s apply rendering' => '%s Rendering anwenden',
'My Tab' => 'Mein Tab',
...
'n.a.' => 'n. v.',
'Do not have blog links to generate statistics' => 'Haben keine Blog-Links zum Generieren von Statistiken',
...
'The proc_* PHP functions are not available on this server.' => 'Die proc_* PHP Funktionen sind auf diesem Server nicht verfügbar.',
...
'WARNING: Some of your tables have different charset than the expected %s. It is strongly recommended to upgrade your database charset by running the tool <a %s>Upgrade your DB to UTF-8</a>.' => 'WARNUNG: Einige Ihrer Tabellen haben einen anderen Zeichensatz als den erwarteten %s. Es wird ausdrücklich empfohlen, dass Sie ihren Datenbankzeichensatz upgraden, indem Sie folgendes Tool laufen lassen: <a %s>Ihre DB auf UTF-8 upgraden</a>.',
...
'Email service preferences' => 'Präferenzen für E-Mail-Service',
'Regular PHP "mail" function' => 'Reguläre PHP "Mail"-Funktion',
'Preferred email service' => 'Bevorzugter E-Mail-Service',
'Force email sending' => 'Senden von E-Mails erzwingen',
'If the preferred email service is not available, the secondary option will be used.' => 'Wenn der bevorzugte E-Mail-Service nicht verfügbar ist, wird die sekundäre Option verwendet.',
...
'Settings to connect with SMTP Server' => 'Einstellungen zur Verbindung mit SMTP Server',
...
'Clear pre-renderered message cache (DB)' => 'Vorgerenderten Nachrichten-Cache leeren (DB)',
...
'Cleanup tools' => 'Tools zum Aufräumen',
...
'Upgrade your DB to UTF-8 - DB only.' => 'Ihre DB auf UTF-8 upgraden - nur DB.',
...
'Log type' => 'Protokoll-Typ',
'Core' => 'Kern',
'Origin type' => 'Herkunftsart',
'Origin ID' => 'Herkunft ID',
'Object type' => 'Objekttyp',
'Origin' => 'Herkunft',
'Object' => 'Objekt',
'Empty object ID' => 'Leere Objekt-ID',
'No item' => 'Kein Element',
'No file' => 'Keine Datei',
'Object Link' => 'Objekt-Link',
...
'Minimum user group level must be 0.' => 'Minimales Benutzergruppenlevel muss 0 sein.',
'Maximum user group level must be 10.' => 'Maximales Benutzergruppenlevel muss 10 sein.',
...
'%d message by this user' => '%d Nachricht von diesem Benutzer',
'%d message read status about this user' => '%d gelesene Status über diesen Benutzer',
...
'%s has posted %s comments (%s%% of which are public).<br />%s voted useful by %s different users.<br />%s voted NOT useful by %s different users.<br />%s considered OK by %s different users.<br />%s considered SPAM by %s different users.</span>' => '%s hat %s Kommentare eingetragen (%s%% davon sind öffentlich).<br />Von %s haben %s verschiedene Benutzer für "hilfreich" gestimmt.<br />Von %s haben %s verschiedene Benutzer für "nicht hilfreich" gestimmt.<br />Von %s betrachten %s verschiedene Benutzer dies als OK.<br />Von %s betrachten %s verschiedene Benutzer dies als Spam.</span>',
...
'Display first image separately and before title.' => 'Erstes Bild separat und vor dem Titel anzeigen ',
...
'Display a count of the blog members.' => 'Die Anzahl der Blog-Mitglieder anzeigen',
...
'Email capture / Quick registration widget' => 'E-Mail-Capture / Schnellregistrierungs-Widget',
...
'Title of a button to submit a form.' => 'Button-Titel zum Versenden eines Formulars.',
...
"<p>This is the intro post for the front page of Blog A.</p>\n\n<p>Blog A is currently configured to show a front page like this one instead of directly showing the blog's posts.</p>\n\n<ul>\n<li>To view the blog's posts, click on \"News\" in the menu above.</li>\n<li>If you don't want to have such a front page, you can disable it in the Blog's settings > Features > <a %s>Front Page</a>. You can also see an example of a blog without a Front Page in Blog B</li>\n</ul>" => "<p>Dies ist der Intro-Eintrag für die Startseite von Blog A.\n\n</p> <p>Blog A ist momentan so konfiguriert, dass er eine Startseite wie diese anzeigt, anstatt direkt die Einträge des Blogs anzuzeigen.</p>\n\n<ul>\n<li>Um die Einträge des Blogs zu sehen, klicken Sie oben in dem Menü auf \"Neuigkeiten\".</li> <li>Wenn Sie so eine Startseite nicht haben möchten, können Sie sie in den Blog-Einstellungen > Features > <a %s>Startseite</a> ändern. In Blog B können Sie ein Beispiel dafür sehen, wie ein Blog ohne Startseite aussieht.</li>\n</ul>",
...
'Upgrade your DB to UTF-8' => 'Ihre DB auf UTF-8 upgraden',
...
'WARNING: Some of your tables have different charset than the expected %s. It is strongly recommended to upgrade your database charset by running the preselected task below:' => 'WARNUNG: Einige Ihrer Tabellen haben einen anderen Zeichensatz als den erwarteten %s. Es wird ausdrücklich empfohlen, dass Sie ihren Datenbankzeichensatz upgraden, indem Sie folgende, vorausgewählte Aufgaben laufen lassen:',
...
'You must turn on the <b>"Show location coordinates"</b> setting in Blog settings <a %s>Post Features</a> tab so the Google Maps plugin can save its coordinates.' => 'Sie müssen die Einstellung  <b>"Ortskoordinaten anzeigen"</b> in den Blog-Einstellungen <a %s>Eintrags-Feature</a> Tab aktivieren, damit das Google Maps Plugin seine Koordinaten speichern kann.',
...
'Minimum Heading Level' => 'Minimale Überschriftshöhe',
'This plugin will adjust headings so they can never be lower than the level you want: 2 for &lt;H2&gt;, 3 for &lt;H3&gt;, etc.' => 'Dieses Plugin wird die Überschrift so anpassen, dass sie nie niedriger ist als Sie es möchten: 2 für &lt;H2&gt;, 3 für &lt;H3&gt;, etc.',
...
'The url is not avaialble, please check it, probably it is old url of GeoIP.dat file.' => 'Diese URL ist nicht verfügbar, bitte überprüfen Sie sie. Wahrscheinlich ist es die alte URL der GeoIP.dat Datei.',
'Plugin folder %s must be writable to put the downloading GeoIP.dat. Please set the write rights and try it again.' => 'Der Plugin-Ordner %s muss schreibbar sein, um die GeoIP.dat zu platzieren. Bitte wählen Sie die nötigen Schreibberechtigungen aus und versuchen Sie es erneut.',
...
'Could not open the package file!' => 'Die Paketdatei konnte nicht geöffnet werden!',
'Could not open the file %s to save the extracting file, please check the rights.' => 'Die Datei %s konnte zum Speichern der zu extrahierenden Datei nicht gespeichert werden. Bitte überprüfen Sie die Berechtigungen.',
'Remove gzip file %s...' => 'gzip Datei %s entfernen...',
'Impossible to remove file %s. You can do it manually.' => 'Die Datei %s konnte nicht entfernt werden. Sie können dies manuell tun.',
'GeoIP.dat file was downloaded successfully, you can go to <a %s>here</a> to enabled the plugin.' => 'Die GeoIP.dat Datei wurde erfolgreich heruntergeladen. Sie können nach <a %s>hier</a> gehen, um das Plugin zu aktivieren. ',
...
'This plugin will adjust headings so they can never be lower than the level you want: 1 for &lt;H1&gt;, 2 for &lt;H2&gt;, etc.' => 'Dieses Plugin wird die Überschrift so anpassen, dass sie nie niedriger ist als Sie es möchten: 1 für &lt;H1&gt;, 2 für &lt;H2&gt;, etc.',
'Bold' => 'Fett',
'Italic' => 'Kursiv',
...
'Sorry, you don\'t have permission to access the back-office / admin interface.' => 'Entschuldigung, Sie haben nicht die Berechtigung auf die Back-Office-/Admin-Benutzeroberfläche zuzugreifen.',
