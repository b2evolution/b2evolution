...
$trans['de_DE'] = array(
	...
	'You must not create empty locales!' => "Du darfst keine leeren Locales erstellen!",
	...
	'You have no permission to edit users/groups!' => "Du darfst keine Benutzer/Gruppen ändern!",
	...
	'The login already exists. Please <a %s>edit this login</a> instead of overwriting it this way.' => "Der Login existiert bereits. Bitte <a %s>editiere diesen Login</a> anstatt ihn so zu überschreiben.",
	...
	'Couldn\'t change %s\'s level.' => "Konnte %s's Level nicht ändern.",
	...
	'The group name already exists. Please <a %s>edit this group</a> instead of overwriting it this way.' => "Der Gruppenname existiert bereits. Bitte <a %s>editiere diese Gruppe</a> anstatt sie so zu überschreiben.",
	...
	'Source Stub Filename' => "Quellen-Stub-Dateiname",
	'This is the .php file that will be executed to generate a static version of the blog homepage. This should typically be a stub file.' => "Das ist die .php-Datei, die ausgeführt wird, um eine statische Version der Blog-Homepage zu generieren. Dies sollte typischerweise eine Stub-Datei sein.",
	'Destination Static Filename' => "Entstehender statischer Dateiname",
	...
	'No trailing slash. (If you don\'t know, leave this field empty.)' => "Kein anhängenden Slash am Ende. (Wenn du nicht weisst, lass dieses Feld leer.)",
	...
	'should the locale be available?' => "soll diese Locale verfügbar sein?",
	'name of the locale' => "Name der Locale",
	'Charset' => "Zeichensatz",
	'the charset for this locale. see <a %s>the specs</a>' => "der Zeichensatz für diese Locale, siehe <a %s>Format-Beschreibung</a>",
	'Date format' => "Datumsformat",
	'the date format, see <a %s>the specs</a>' => "das Datumsformat, siehe <a %s>Format-Beschreibung</a>",
	'Time format' => "Zeitformat",
	'the time format, see <a %s>the specs</a>' => "das Zeitformat, siehe <a %s>Format-Beschreibung</a>",
	'Lang file' => "Sprachdatei",
	'the message file being used, from <code>locales</code> subdirectory' => "die message Datei die aus dem Unterverzeichnis <code>locales</code> benutzt wird",
	'Priority' => "Priorität",
	'1 is highest. It\'s use is for locale autodetect (from HTTP_ACCEPT_LANGUAGE header), when we have more than locale with the requested language. It also affects the order in which locales are shown in dropdown boxes etc.' => "1 ist höchste. Es wird für automatische Locale-Erkennung (vom HTTP_ACCEPT_LANGUAGE-Header) benutzt, wenn mehrere Locales mit der angeforderten Sprache vorhanden sind. Es hat ausserdem Einfluss darauf, in welcher Reihenfolge Locales in Dropdown-Boxen angezeigt werden etc.",
	'Create' => "Erstellen",
	'This will replace locale \\\'%s\\\'. Ok?' => "Das wird Locale \\'%s\\' ersetzen. Ok?",
	'We\'ll use the flag out of subdirectories from <code>%s</code>, where the filename is equal to the language part of the locale (characters 4-5; file extension is gif).' => "Wir werden die Fahne aus Unterverzeichnissen von <code>%s</code> benutzen, wobei der Dateiname dem Sprachen-Teil der Locale entspricht (Zeichen 4-5; Dateiendung ist gif).",
	...
	'Default locale. Overwritten from HTTP_ACCEPT_LANGUAGE header, user locale or blog locale (in this order).' => "Standard-Locale. Wird von HTTP_ACCEPT_LANGUAGE-Header, Benutzer-Locale oder Blog-Locale überschrieben (in dieser Reihenfolge).",
	...
	'one post on this day' => "ein Eintrag an diesem Tag",
	'%d posts in this month' => "%d Einträge in diesem Monat",
	'one post in this month' => "ein Eintrag in diesem Monat",
	'previoust month' => "voriger Monat",
	...
	'Sorry, your b2evolution database does not match the script version.' => "Sorry, deine b2evolution Datenbank passt nicht zur Version des Scripts.",
	'New user' => "Neuer Benutzer",
	...
	'The minimum requirement for this version of b2evolution is PHP version %s, but you have %s!' => "Die Mindestvoraussetung für diese Version von b2evolution ist PHP Version %s, aber du hast %s!",
	'Could not connect to database! Check you settings in <code>%s</code>!' => "Konnte nicht zur Datenbank verbinden! Überprüfe deine Einstellungen in <code>%s</code>!",
	'First time install' => "Erste Installation",
	'PHP version' => "PHP Version",
	'These are your settings from the config file:' => "Das sind deine Einstellungen aus der Config-Datei:",
	'(If you don\'t see correct settings here, STOP before going any further, and check your configuration.)' => "(Falls du hier keine korrekten Werte siehst, HÖR AUF weiterzumachen und überprüfe deine Konfiguration.)",
	'Host' => "Host",
	'Database' => "Datenbank",
	'Username' => "Benutzername",
	'Password' => "Passwort",
	'(Set, but not shown for security reasons)' => "(Gesetzt, aber aus Sicherheitsgründen nicht angezeigt)",
	'What do you want to install?' => "Was willst du installieren?",
	'The database tables installation can be done in different ways. Choose one:' => "Die Installation der Datenbank-Tabellen kann auf verschiedene Weise erfolgen. Wähle eine:",
	...
	'Install Database Tables Now !' => "Installiere jetzt die Datenbank-Tabellen !",
