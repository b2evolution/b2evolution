...
$trans['de_DE'] = array(
	...
	'Deleted settings for locale [%s] in database.' => "Sprache '%s' aus Datenbank gelöscht.",
	'Inserted (and disabled) locale [%s] into database.' => "Sprache '%s' in Datenbank eingefügt (und deaktiviert).",
	'Inserted locale [%s] into database.' => "Sprache '%s' in Datenbank eingefügt.",
	'Saved locale [%s].' => "Sprache '%s' gespeichert.",
	...
	'Deleted locale [%s] from database.' => "Sprache '%s' aus Datenbank gelöscht.",
	...
	'File settings updated.' => "Dateieinstellungen aktualisiert.",
	...
	'Response:' => "Antwort:",
	'New user' => "Neuer Benutzer",
	'The user\'s directory [%s] could not be created.' => "Das Benutzerverzeichnis [%s] konnte nicht erstellt werden.",
	'The user\'s directory [%s] has been created with permissions %s.' => "Das Benutzerverzeichnis [%s] wurde mit den Berechtigungen %s erstellt.",
