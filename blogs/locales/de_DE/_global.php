...
'Scheduled task #%d deleted.' => 'Geplanter Job #%d gelöscht.',
...
'Database setup for plugin #%d (%s)' => 'Datenbank Einrichtung für Plugin #%d (%s)',
...
'Reporting abuse to' => 'Berichte Missbrauch an',
...
'Requesting abuse list from' => 'Fordere Missbrauchsliste an von',
...
'Validate your email address for $laquo;%s&raquo;' => 'Validiere Deine E-Mail-Adresse für &laquo;%s&raquo;',
...
'Blog URL parameters' => 'Blog URL Parameter',
...
'Used to uniquely identify this blog. Appears in URLs when using extra-path info. Also gets used as default for the media location (see the advanced tab).' => 'Identifiziert das Blog eindeutig. Erscheint in der URL wenn Extra-Pfad Info benutzt wird. Ausserdem wird es als Standard für den Medien-Speicherort verwendet (siehe "Erweitert").',
...
'Repeat' => 'Wiederholen',
'Delete this task!' => 'Lösche diesen Job!',
'Execute pending tasks in a popup window now!' => 'Führe wartende Jobs in einem Popupfenster jetzt aus!',
...
'Show file types' => 'Zeige Dateitypen',
...
'KB (This cannot be higher than your PHP/Webserver setting!)' => 'KB (Dies kann nicht höher als die PHP/Webserver-Einstellung sein!)',
...
'Users must validate' => 'Benutzer müssen sich validieren',
...
'Has the user been validated (through email)?' => 'Wurde der Benutzer (durch E-Mail) validiert?',
'Validated' => 'Validiert',
...
'Focus on first input text field' => 'Fokussiere das erste Formulareingabefeld',
...
'This overrides any specific media file permissions on specific blogs.' => 'Dies hat Vorrang vor allen spezifischen Medien-Berechtigungen on spezifischen Blogs.',
...
'You must validate your email address (%s) before you can log in.' => 'Du musst Deine E-Mail-Adresse (%s) validieren, bevor Du Dich einloggen kannst.',
'01' => '01',
'02' => '02',
'03' => '03',
'04' => '04',
...
'New set' => 'Neuer Satz',
'The value for %s must be numeric.' => 'Der Wert für %s muss numerisch sein.',
...
'The plugin recommends version %s of the plugin API (%s is installed). Think about upgrading your %s installation.' => 'Das Plugin empfiehlt Version %s der Plugin API (%s ist installiert). Denke über ein Upgrade Deiner %s Installation nach.',
'The plugin requires version %s of the plugin API, but %s is installed. You will probably have to upgrade your %s installation.' => 'Das Plugin erfordert Version %s der Plugin API, aber %s ist installiert. Du wirst wahrscheinlich Deine %s Installation upgraden müssen.',
...
Um mit dem Anpassen eines Skins zu beginnen, öffne dessen \'<code>main.page.php</code>\' Datei in einem Editor (bevorzugt mit einem der PHP/HTML-Syntax kennt und hervorhebt) und lies die Kommentare dort. Ausserdem solltest du die Anleitung zu evoSkins lesen!',
...
'ANY BUT' => 'JEDE AUSSER',
'ALL' => 'ALLE',
'Checks the user\'s IP address against a list of DNS blacklists.' => 'Überprüft die IP-Adresse des Benutzers gegen eine Liste von DNS-Blacklisten.',
'If the IP address is blacklisted, the request is canceled early and the user can (optionally) whitelist his session through a Captcha plugin.' => 'Wenn die IP-Adresse auf der schwarzen Liste ist, wird der Request abgebrochen und der Benutzer kann seine Session durch ein Captcha-Plugin whitelisten (optional).',
'DNS Blacklists' => 'DNS Blacklisten',
'The list of DNS blacklists to query, separated by whitespace.' => 'Die Liste der DNS-Blacklists (schwarze Listen), die abgefragt werden sollen - getrennt durch Leerzeichen.',
'Whitelisting' => 'Whitelisting',
'Allow the user to whitelist his session through a Captcha plugin.' => 'Erlaube dem Benutzer, seine Session durch ein Captcha-Plugin zu validieren.',
'Whitelist timeout' => 'Whitelist-Timeout',
'in seconds. How long should a session be whitelisted?' => 'in Sekunden. Wie lange soll eine Session auf der weissen Liste verbleiben?',
'Statistics' => 'Statistiken',
'Enable statistics. This generates a small overhead, but will show you how effective it is.' => 'Aktiviere Statistiken. Dies generiert einen kleinen Overhead, aber erlaubt es, die Effektivität zu beurteilen.',
'Query URL' => 'Abfrage-URL',
'URL to query an IP address in the browser ("%IP%" gets replaced by the IP address).' => 'URL, um eine IP-Adresse im Browser abzufragen ("%IP%" wird durch die IP-Adresse ersetzt).',
'Retry slow lists' => 'Wiederhole langsame Listen',
'How often should a slow list be retried? (0 to deactivate slow list handling)' => 'Wie oft sollen langsame Listen erneut benutzt werden? (0 um das Behandeln langsamer Listen zu deaktivieren)',
'Timeout' => 'Timeout',
'in seconds. When is a DNSBL considered to be too slow?' => 'in Sekunden. Wann ist eine DNSBL als langsam einzuordnen?',
'DNSBL' => 'DNSBL',
'No DNS blacklists given!' => 'Keine DNS Blacklisten angegeben.',
'Checking for &laquo;%s&raquo; in DNS blacklists.' => 'Überprüfe &laquo;%s&raquo; in DNS Blacklisten.',
'Cleared statitics.' => 'Statistiken zurückgesetzt.',
'Lookup address in DNS blacklists' => 'Schaue nach Adresse in DNS Blacklisten',
'Check' => 'Überprüfen',
'Check my lists' => 'Überprüfe meine Listen',
'Check at openrbl.org' => 'Überprüfe bei openrbl.org',
'Too slow lists' => 'Zu langsame Listen',
'If DNS blacklists are detected as being too slow they get deactivated here.' => 'Wenn DNS-Blacklisten als zu langsam erkannt wurden, werden sie hier deaktiviert.',
'This blacklist was %d times too slow.' => 'Diese Blackliste war %d mal zu langsam.',
'Blocked requests' => 'Blockierte Anfragen',
'Whitelisted requests' => 'Whitelisted Anfragen',
'Not blocked requests' => 'Nicht geblockte Anfragen',
'The above statistics are from %s to %s.' => 'Die obigen Statistiken sind von %s bis %s.',
'Clear statistics' => 'Setze Statistiken zurück',
'Your IP address is listed in &laquo;%s&raquo;.' => 'Deine IP-Adresse ist gelistet in &laquo;%s&raquo;.',
'Your IP address is blocked.' => 'Deine IP-Adresse ist blockiert.',
'Whitelisting is not enabled. You cannot access this site with your current IP address. Your only hope might be to get a new IP address by re-connecting to your Internet Service Provider.' => 'Whitelisting ist nicht aktiviert. Du kannst nicht auf diese Seite zugreifen. Deine einzige Hoffnung dürfte es sein, eine neue IP-Adresse zu bekommen, indem Du Dich neu zu Deinem Internet Service Anbieter verbindest.',
'There is no Captcha plugin installed. Whitelisting is disabled.' => 'Es ist kein Captcha-Plugin aktiviert. Whitelisting ist deaktiviert.',
...
'Selector' => 'Auswahl',
'Echo a random number in AdminBeginPayload event' => 'Gib eine zufällige Zahl im AdminBeginPayload Ereignis aus',
'Humane Web Text Generator 2.0 beta' => 'Humane Web Text Generator 2.0 beta',
'Transport optimizer' => 'Transport Optimierer',
'Save bandwidth on your server.' => 'Spare Bandbreite auf Deinem Server.',
'By providing support of ETag headers and GZip compression it saves bandwidth on the server and optimizes the transport to the browser.' => 'Durch Unterstützung von ETag-Headern und GZip-Kompression wird Bandbreite auf dem Server gespart und der Transport zum Browser optimiert.',
'ETag header' => 'ETag-Header',
'This will send an ETag header with every page, so we can say "Not Modified." if exactly the same page had been sent before.' => 'Dies sendet einen ETag-Header mit jeder Seite, so dass wir "Nicht verändert" sagen können, wenn die gleiche Seite schon einmal vorher gesendet worden ist.',
'GZip compression' => 'GZip Kompression',
'If enabled, the plugin will buffer the output and compress it before sending it to the browser. It is recommened to use the php.ini option zlib.output_compression or a webserver module instead.' => 'Falls aktiviert, wird das Plugin die Ausgabe puffern und komprimieren, bevor sie zum Browser geschickt wird. Es wird empfohlen, stattdessen die php.ini-Option zlib.output_compression oder ein Webserver-Modul zu verwenden.',
'Last-Modified' => 'Last-Modified',
'This will send a Last-Modified header with the current time.' => 'Dies sendet einen Last-Modified-Header ("zuletzt geändert") mit der aktuellen Zeit.',
'The PHP function gzencode() is not available. GZip compression is disabled.' => 'Die PHP-Funktion gzencode() ist nicht verfügbar. GZip-Kompression ist deaktiviert.',
...
'Check trackbacks for URL' => 'Überprüfe Trackbacks auf URL',
'Check trackback pages, if they contain our URL. This may generate a lot of additional traffic!' => 'Überprüfe Trackback-Seiten, ob sie unsere URL enthalten. Dies kann eine Menge zusätzlichen Traffic generieren!',
...
'Could not find link to us in your URL!' => 'Konnte keinen Link zu uns in Deiner URL finden!',
