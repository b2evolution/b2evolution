...
$trans['nl_NL'] = array(
	...
	'This group name already exists! Do you want to <a %s>edit the existing group</a>?' => "De Login bestaat al. Gebruik <a href=\"%s\">bewerk deze login</a> in plaats van overschrijven op deze manier.",
	...
	'the lang file to use, from the <code>locales</code> subdirectory' => "het berichten bestand wat word gebruikt, van de <code>locales</code> subdirectory",
	'Priority' => "Prioriteit",
	'1 is highest. Priority is important when selecting a locale from a language code and several locales match the same language; this can happen when detecting browser language. Priority also affects the order in which locales are displayed in dropdown boxes, etc.' => "1 is het hoogste. Het word gebruikt voor de automatische taal detectie (van HTTP_ACCEPT_LANGUAGE header), wanneer we meer vertalingen hebben met de gewenste taal. Het heeft ook invloed op de volgorde waarmee de vertalingen worden getoond in de dropdown lijstjes etc.",
	'Create' => "Aanmaken",
