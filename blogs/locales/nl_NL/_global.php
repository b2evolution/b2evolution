...
$trans['nl_NL'] = array(
	...
	'This group name already exists! Do you want to <a %s>edit the existing group</a>?' => "De groepsnaam bestaat al. Wil je <a href=\"%s\">deze bestaande groep bewerken</a>?",
	...
	'Fallback to ID when no URL title available.' => "Valt terug op ID als er geen URL titel beschikbaar is.",
	...
	'Charset' => "Tekenset",
	'Must match the lang file charset.' => "Moet gelijk zijn aan de karakterset van het taal bestand.",
	'Date format' => "Datum formaat",
	'See below.' => "Zie beneden.",
	'Time format' => "Tijd formaat",
	'Lang file' => "Taal bestand",
	'the lang file to use, from the <code>locales</code> subdirectory' => "het taal bestand wat word gebruikt, van de <code>locales</code> subdirectory",
	'Priority' => "Prioriteit",
	...
	'**bold** \\italics\\ //italics// __underline__ Markup must be preceeded with white space.' => "**bold** \\italics\\ //italics// __underline__ Markup moet worden gevolgd door spaties.",
	'Convert text smilies to icons' => "Converteer tekst smilies naar iconen",
	'Humane Web Text Generator' => "Humane Web Tekst Generator",
	...
	'One click smilies inserting' => "Met één klik smilies inbrengen",
	...
	'The <acronym title="Uniform Resource Identifier">URI</acronym> to TrackBack this entry is:' => "De <acronym title=\"Uniform Resource Identifier\">URI</acronym> om TrackBack dit artikel is:",
	'E-mail' => "E-mail",
	...
	'Other' => "Andere",
	'Meta' => "Meta",
	'Syndicate this site using RSS' => "Syndicate dit weblog met RSS",
