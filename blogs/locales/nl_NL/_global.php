...
$trans['nl_NL'] = array(
	...
	'Could not load original conf file [%s]. Is it missing?' => "Kon het originele configuratie bestand niet laden [%s]. Bestaat deze wel?",
	...
	'Your config file has not been edited yet. You can do this by filling in the form below.' => "Je configatie bestand is nog niet bewerkt. Je kan dit doen door het onderstaande formulier in te vullen.",
	...
	'<p>If you have installed b2evolution tables before and wish to start anew, you must delete the b2evolution tables before you can start a new installation. b2evolution can delete its own tables for you, but for obvious security reasons, this feature is disabled by default.</p>' => "If you have installed b2evolution tables before and wish to start anew, you must delete the\n\t\t\t\t\tb2evolution tables before you can start a new installation. <strong>WARNING: All your b2evolution\n\t\t\t\t\ttables and data will be lost!!!</strong> Your Cafelog/b2 or any other tables though, if you have\n\t\t\t\t\tsome, will not be touched in any way.",
	'Config file recap...' => "Configuratie bestand ophalen...",
	'If you don\'t see correct settings here, STOP before going any further, and <a %s>redo your configuration</a>.' => "(Als je hier niet de juiste instellingen ziet, STOP dan voordat je verder gaat, en <a %s>controleer jouw configuratie</a>.)",
	...
	'<p>For security reasons, the reset feature is disabled by default.</p>' => "<p>Om beveiligingsredenenen, is de reset functie standaard uitgeschakeld.</p>",
	...
	'However, the main purpose for this blog is to be included as a side item to other blogs where it will display your favorite/related links.' => "Maar, het hoofddoel voor dit weblog is om te worden bijgevoegd als een zijbalk van andere weblogs waar het jouw favorieten/gerelateerde websites zal bevatten.",
