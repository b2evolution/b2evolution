...
$trans['nl_NL'] = array(
	...
	'Antispam' => 'AntiSpam',
	'You have no right to edit the blacklist.' => 'Je hebt geen rechten om de zwarte lijst te bekijken.',
	'The keyword %s is already handled by the blacklist!' => 'Het sleutelwoord %s staat reeds op de zwarte lijst!',
	'The keyword %s is too short, it has to be a minimum of 3 characters!' => 'Het sleutelwoord %s is te kort, het moet minimaal 3 karakters bevatten!',
	...
	'Ban the keyword + delete matching hits and comments' => 'Ban het sleutelwoord + verwijder bijpassende hits en reacties',
	...
	'Any URL containing one of the following keywords will be banned from posts, comments and logs. If a keyword restricts legitimate domains, click on the green tick to stop banning with this keyword.' => 'Iedere URL die 1 van de volgende sleutelwoorden bevat woord geband van artikels, reacties en weblogs. Als een sleutelwoord legitieme domeinen tegenhoud, klik dan op het groene vinkje om te stoppen met bannen van dit sleutelwoord.',
	...
	'Request abuse update from centralized blacklist.' => 'Vraag een misbruik update van de centrale zwarte lijst.',
	...
	'Removing all related comments and hits...' => 'Verwijderen van alle gerelateerde reacties en hits...',
