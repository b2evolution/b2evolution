...
$trans['lt_LT'] = array(
	...
	'Multilingual multiuser multi-blog engine.' => "Daugiakalbė daugiavartotojiška multiblogų sistema!",
	...
	'Plug-ins' => "Įskiepiai",
	'Parameter %s required!' => "Parametras %s būtinas!",
	...
	'Other blog through stub file' => "Kitas blogas per stub failą",
	...
	'Charset' => "Koduotė",
	'the charset for this locale. see <a %s>the specs</a>' => "šios lokalės koduotė, žiūrėti <a %s>specifikacijas</a>",
	'Date format' => "Datos formatas",
	'the date format, see <a %s>the specs</a>' => "datos formatas, žiūrėti <a %s>specifikacijas</a>",
	'Time format' => "Laiko formatas",
	'the time format, see <a %s>the specs</a>' => "laiko formatas, žiūrėti <a %s>specifikacijas</a>",
	...
	'one post on this day' => "vienas įrašas šią dieną",
	'%d posts in this month' => "%d įrašų tą mėnesį",
	'one post in this month' => "vienas įrašas šį mėnesį",
	...
	'The minimum requirement for this version of b2evolution is PHP version %s, but you have %s!' => "Minimalūs reikalavimai šiai b2evolution versijai yra PHP versija %s, bet pas jus yra %s!",
	...
	'Installing b2evolution tables and copying existing b2 data' => "Instaliuojamos b2evo lentelės ir kopijuojami b2 duomenys",
	...
	'Humane Web Text Generator' => "Humane Web Text Generatorius",
