...
$trans['zh_TW'] = array(
	...
	'Users will be able to select another skin to view the blog (and their preferred skin will be saved in a cookie).' => "使用者能夠選擇別種樣式來瀏覽這個Blog(喜歡的樣式則會存在他們的cookie中)",
