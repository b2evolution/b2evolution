...
$trans['nb_NO'] = array(
	...
	'Antispam' => 'Antispam',
	'You have no right to edit the blacklist.' => 'Du har ikke rettigheter nok til å redigere svartelisten.',
	'The keyword %s is already handled by the blacklist!' => 'Nøkkelordet %s er allerede håndtert i svartelisten!',
	'The keyword %s is too short, it has to be a minimum of 3 characters!' => 'Nøkkelordet %s er for kort, det må være minst 3 tegn!',
	'Confirm ban &amp; delete' => 'Godkjenn svartelisting &amp; sletting',
	'Banning the keyword %s from the statistics and comments would lead to the deletion of the following %d comments:' => 'Å svarteliste nøkkelordet %s fra statistikken og kommentarene vil føre til slettingen av de følgende %d kommentarene:',
	'...and the following %d referer hits:' => '...og de følgende %d treffene:',
	'Are you sure you want to continue?' => 'Er du sikker på at du vil fortsette?',
	'Ban the keyword + delete matching hits and comments' => 'Svartelist nøkkelordet + slett treff og kommentarer',
	'Removing entry #%d from the ban list...' => 'Fjerner punkt nr. %d fra svartelisten...',
	'Banned domains blacklist' => 'Svartelistede domener',
	'Any URL containing one of the following keywords will be banned from posts, comments and logs. If a keyword restricts legitimate domains, click on the green tick to stop banning with this keyword.' => 'En URL som inneholder et av de følgende nøkkelordene vil bli nektet å poste kommentarer og logge treff, samt nektes i bruk i en post. Hvis et nøkkelord begrenser legitime domener, kan du klikke på den grønne haken for å fjerne dette nøkkelordet fra svartelisten.',
	...
	'Keyword' => 'Nøkkelord',
	'Ban this keyword!' => 'Svartelist nøkkelordet!',
	'Blogs' => 'Blogger',
	...
	'You have no right to change a hit type.' => 'Du har ikke rettigheter nok til å forandre treff-typer.',
	'Changing hit #%d type to: %s' => 'Endrer treff nr. %ds type til: %s',
	'You have no right to delete a hit.' => 'Du har ikke rettigheter nok til å slette treff.',
	...
	'The admin disabled this function' => 'Administratoren har slått av denne funksjonen',
	...
	'The default skin [%s] does not exist. It must be properly set in the blog stub file [%s]. Contact the <a %s>webmaster</a>...' => 'Det ønskede skinnet [%s] eksisterer ikke. Det må innstilles riktig i bloggens stubb fil [%s]. Kontakt <a %s>vevmesteren</a>...',
	...
	'Banning the keyword %s...' => 'Svartelister nøkkelordet %s...',
	'Removing all related comments and hits...' => 'Sletter alle tilknyttede kommentarer og treff...',
	...
	'Original post on %s' => 'Opprinnelig postet på %s',
