...
$trans['nb_NO'] = array(
	...
	'Note: Moving categories across blogs is disabled.' => "Merk: Kryssposting mellom flere blogger er tillatt.",
	...
	'Supplied content is invalid' => "Følgende URL er ugyldig:",
	...
	'English (NZ)' => "Engelsk (EU)",
	'English (SG)' => "Engelsk (US)",
	'Spanish (ES)' => "Spansk (ES)",
	'Spanish (MX)' => "Spansk (ES)",
	'Spanish (VE)' => "Spansk (ES)",
	'Finnish (FI)' => "Engelsk (IL",
	'French (FR)' => "Fransk (FR)",
	'French (CA)' => "Fransk (CA)",
	'French (BE)' => "Fransk (BE)",
	'Galician (ES)' => "Italiensk (IT)",
	...
	'Supplied name is invalid' => "Følgende URL er ugyldig:",
	...
	'Supplied comment is invalid' => "Følgende URL er ugyldig:",
	'You can only post a new comment every %d seconds.' => "Du kan ikke poste kommentarer oftere enn hvert 30. sekund.",
	...
	'You cannot reset this account in demo mode.' => "Du kan ikke forandre demobrukerens profil i demomodus!",
	...
	'Wacko style formatting' => "GreyMatter-type tekstformatering",
