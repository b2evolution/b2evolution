...
$trans['ja_JP'] = array(
	...
	'Permission to post into this blog with draft status' => "このブログへドラフト状態での投稿をする権限",
	...
	'%d user rights defintions' => "%d ユーザ権限定義",
	...
	'You have no email address with your profile, therefor we cannot reset your password.' => "あなたのプロフィールにメールアドレスが登録されていないので、あなたのパスワードをリセットすることができません。",
