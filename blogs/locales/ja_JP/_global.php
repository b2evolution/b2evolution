...
$trans['ja_JP'] = array(
	...
	'Other blog through stub file' => "スタブ ファイルを使用する他のブログ",
	...
	'Check this if you want to display the list of all blogs on your blog page (if your skin supports this).' => "あなたのブログ ページに全てのブログのリストを表示したい場合はチェックしてください (スキンがこれをサポートしている場合)。",
	...
	'Select main category in target blog and optionally check additional categories' => "対象のブログでのメインのカテゴリを選択して、任意で追加カテゴリもチェックしてください",
	...
	'official website' => "公式ウェブサイト",
	'contact' => "連絡",
	'This blog holds all your posts upgraded from Cafelog. This blog is named \'%s\'. It has index #%d in the database. By default it is accessed through a stub file called \'<code>%s</code>\'. %s' => "このブログはCafelogからアップグレードされたあなたの投稿すべてを収めています。このブログは '%s' という名前です。データベースの index #%d に登録されています。デフォルトで、'<code>%s</code>' というスタブ ファイルでアクセスされます。%s",
	...
	'**bold** \\italics\\ //italics// __underline__ Markup must be preceeded with white space.' => "**太字** \\斜体\\ //斜体// __下線__ マークアップは空白の後に続ける必要があります。",
	'Convert text smilies to icons' => "スマイリー (顔文字) をアイコンに変換",
	'Humane Web Text Generator' => "人に優しいウェブテキスト ジェネレータ",
