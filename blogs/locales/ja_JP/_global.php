...
$trans['ja_JP'] = array(
	...
	'Deleted %d log hits matching &laquo;%s&raquo;.' => "%d 件の &laquo;%s&raquo; に一致したログ・ヒットを削除しました。",
	...
	'None' => "なし",
	'Changing hit #%d type to: %s' => "ヒット #%d のタイプを %s に変更",
	...
	'These are hits from RSS news aggregators. (Aggregators must be listed in /conf/_stats.php)' => "以下は RSS ニュースアグリゲータからのヒットです(アグリゲータは /conf/_stats.php にリストされている必要があります)。",
	...
	'Enable Online Help links' => "オンライン・ヘルプのリンクを有効",
	'Online help links provide context sensitive help to certain features.' => "オンライン・ヘルプ・リンクは特定の機能において内容に関連したヘルプを提供します。",
	'Blog by email' => "メールでブログ",
	'Enable Blog by email' => "メールでブログを許可",
	'Check to enable the Blog by email feature.' => "Eメールでブログする機能を有効にする場合はチェックをつける。",
	'POP3' => "POP3",
	'POP3 (experimental)' => "POP3 (実験段階)",
	'Email retrieval method' => "Eメール受信方法",
	'Mail Server' => "メールサーバ",
	'Hostname or IP Address of your incomming mail server.' => "あなたの受信用メールサーバのホストネームかIPアドレス",
	'Port Number' => "ポート番号",
	'Port number of your incomming mail server (defaults pop3:110 imap:143).' => "あなたの受信用メールサーバのポート番号 (デフォルトは POP3:110 IMAP:143)",
	'Account Name' => "アカウント名",
	...
	'By default email blogs will have this category.' => "デフォルトではEメール・ブログはこのカテゴリになります。",
	...
	'Hit logging' => "ヒット記録",
	'Double-check Referer' => "リファラの二重チェック",
	...
	'no' => "いいえ",
	'Admin skin' => "管理画面スキン",
	'The skin defines how the backoffice appears to you.' => "backoffice の見た目を定義するスキンです。",
	...
	'Reported abuse to b2evolution.net.' => "b2evolution.net へ迷惑行為を報告しました。",
	...
	'The blog\'s media directory &laquo;%s&raquo; cannot be created, because the parent directory &laquo;%s&raquo; is not writable.' => "ブログのメディア ディレクトリ &laquo;%s&raquo; は作成できませんでした。親ディレクトリ &laquo;%s&raquo; が書き込みできないためです。",
	...
	'Deprecate!' => "没!",
	'Deprecate this post now!' => "今この投稿を没にする!",
	...
	'Open help for this plugin in a new window.' => "このプラグインのヘルプを新しいウィンドウで開きます。",
	...
	'Check all' => "全てにチェック",
	'Uncheck all' => "全てのチェックを解除",
	'New selection name' => "新規選択名",
	'Update selection' => "選択更新",
	'Selection' => "選択",
	'New selection' => "新規選択",
	'Selection created.' => "選択を作成しました。",
	'Please provide a selection name' => "選択の名称を提供してください",
	'Obsolete selection entries deleted' => "期限切れの選択エントリを削除しました",
	'New selections entries inserted' => "新規の選択エントリを挿入しました",
	'Selection copied' => "選択をコピーしました",
	'Selection links copied' => "選択リンクをコピーしました",
	'Delete selection &laquo;%s&raquo;?' => "選択 &laquo;%s&raquo; を削除しますか?",
	'Cascading deletes!' => "カスケーディングが削除されます!",
	'Selection attachments deleted' => "選択の一部が削除されました",
	'Selection deleted' => "選択を削除しました",
	'Guest Users:' => "ゲスト ユーザ:",
	'Subscriptions' => "購読",
	'All but ' => "以下を除く全て",
	'Keyword(s)' => "キーワード",
	...
	'Blog by email feature not enabled' => "Eメールでブログ機能は無効です",
	...
	'Blog by email feature not configured' => "Eメールでブログ機能は設定されていません",
	...
	'<strong>NOTE:</strong> Your stats will be reset.' => "<strong>メモ:</strong> あなたの統計はリセットされるかもしれません。",
	...
	'This skin tag displays the list of avilable categories for the blog.' => "このスキン タグはブログの利用可能なカテゴリのリストを表示します。",
