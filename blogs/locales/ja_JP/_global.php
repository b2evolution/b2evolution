...
$trans['ja_JP'] = array(
	...
	'Disabled' => "無効",
	'Renderers' => "表示機能",
	'No renderer plugins are installed.' => "表示機能プラグインはインストールされていません。",
	...
	'Email/MSS Auto-BR' => "メール/MSS 自動-BR",
	...
	'Note: Moving categories across blogs is enabled. Use with caution.' => "注意: ブログを越えたカテゴリの移動が可能になっています。注意して使用してください。",
	...
	'General settings have been updated.' => "一般設定が更新されました。",
	'Regional settings have been updated.' => "地域設定が更新されました。",
	...
	'You must provide an relative URL (without <code>http://</code> or <code>https://</code>)!' => "相対URL (<code>http://</code> や <code>https://</code> が付かない)を提供しなければなりません!",
	...
	'File [%s] could not be accessed!' => "ファイル [%s] にアクセスできません!",
	'Click anywhere in this window to close it.' => "このウィンドウのどこでもクリックすれば閉じます。",
	'The selected image' => "選択した画像",
	'File' => "ファイル",
	'empty file' => "空のファイル",
	'%d lines' => "%d 行",
	...
	'Send by mail' => "メールで送信",
	'Download' => "ダウンロード",
	'You want to download:' => "あなたがダウンロードしようとしているのは:",
	'Directory [%s]' => "ディレクトリ [%s]",
	'File [%s]' => "ファイル [%s]",
	'Please give a filename and choose zip format:' => "ファイル名を指定し、zipフォーマットを選択してください:",
	'Archive filename' => "アーカイブ ファイル名",
	'This is the file\'s name that will get sent to you.' => "これはあなたへ送られるファイルの名前です。",
	'Exclude subdirectories' => "サブディレクトリを除外",
	'This will exclude subdirectories of selected directories.' => "選択したディレクトリのサブディレクトリを除外します。",
	'Delete' => "削除",
	'Do you really want to delete [%s]?' => "本当に [%s] を削除しますか？",
	'Could not delete directory [%s] (not empty?).' => "ディレクトリ [%s] が削除できません (空ではない?)。",
	'Could not delete [%s].' => "[%s] を削除できません。",
	'Deleted directory [%s].' => "ディレクトリ [%s] を削除しました。",
	'Deleted file [%s].' => "ファイル [%s] を削除しました。",
	'Failed to set permissions on [%s] to [%s].' => "[%s] の権限を [%s] に設定できませんでした。",
	'Permissions for [%s] not changed.' => "[%s] の権限は変更されていません。",
	'Permissions for [%s] changed to [%s].' => "[%s] の権限を [%s] に変更しました。",
	'Read-only' => "読み取り専用",
	'Read and write' => "読み書き可能",
	'Set new permissions' => "新しい権限の設定",
	'You have no permissions to upload into this directory.' => "このディレクトリにアップロードする権限がありません。",
	'The file [%s] is too big and has not been accepted.' => "ファイル [%s] は大きすぎて、受け付けられませんでした。",
	'The file [%s] does not seem to be a valid upload!' => "ファイル [%s] は正当なアップロードではないようです!",
	'The file [%s] already exists.' => "ファイル [%s] はすでに存在しています。",
	'The file [%s] has been successfully uploaded.' => "ファイル [%s] のアップロードに成功しました。",
	'Navigate to the directory where you want to upload your file(s) into.' => "あなたがファイルをアップロードしたいディレクトリへ操作してください。",
	'Maximum allowed file size: %s' => "許可される最大ファイルサイズ: %s",
	'Files to upload' => "アップロードするファイル",
	'Add another file' => "他のファイルを追加",
	'Invalid source file [%s].' => "不正な元ファイル [%s]。",
	'[%s] is not a valid filename.' => "[%s] は有効なファイル名ではありません。",
	'Source- and target file are the same. Please choose another name or directory.' => "元ファイルと対象ファイルが同じです。別の名前かディレクトリを選んでください。",
	'Renamed [%s] to [%s].' => "[%s] を [%s] に名前変更しました。",
	'Moved [%s] to [%s].' => "[%s] を [%s] に移動しました。",
	'Could not remove [%s], but the file has been copied to [%s].' => "[%s] を削除できませんでしたが、ファイルを [%s] にコピーしました。",
	'Copied [%s] to [%s].' => "[%s] を [%s] にコピーしました。",
	'Could not copy [%s] to [%s].' => "[%s] を [%s] にコピーできませんでした。",
	'Rename' => "名前の変更",
	'Move' => "移動",
	'You are in copy-move-rename mode.' => "現在、コピー・移動・名前変更モードです。",
	'Please navigate to the desired location.' => "希望の場所へ操作してください。",
	'Overwrite existing file' => "既存のファイルを上書き",
	'The existing file [%s] will be replaced with this file.' => "既存ファイル [%s] はこのファイルで置き換えられます。",
	'Keep source file' => "コピー元ファイルを保持する",
	'Do not delete the source file.' => "ソースファイルを削除しない。",
	'Go to your home directory' => "あなたのホーム ディレクトリへ移動",
	'Change root' => "ルートを変更",
	'Normal mode' => "通常モード",
	'All files recursive without directories' => "ディレクトリ無しですべてのファイルを再帰表示",
	'Flat mode' => "フラット モード",
	'Filter is regular expression' => "フィルタは正規表現",
	'RegExp' => "正規表現",
	'Filter' => "フィルタ",
	...
	'The directory is empty.' => "ディレクトリは空です。",
	'with selected files:' => "選択したファイル:",
	'Do you really want to delete the selected files?' => "選択したファイルを本当に削除しますか?",
	...
	'Information' => "情報",
	'Clicking on a file\'s name invokes the default action (images get displayed as image, raw content for all other files).' => "ファイル名をクリックすると、デフォルトの動作を呼び出します (画像は画像として表示され、その他のファイルは未処理の内容が出力されます)。",
	'Clicking on a file\'s icon lets the browser handle the file.' => "ファイルのアイコンをクリックすると、ブラウザにそのファイルの扱いを任せます。",
	'The new window icon (%s) opens the file in a popup window.' => "新しいウィンドウ アイコン (%s) はポップアップ ウィンドウでそのファイルを開きます。",
	'File settings have been updated.' => "ファイル設定が更新されました。",
	...
	'The blog\'s media directory [%s] could not be created.' => "ブログのメディア ディレクトリ [%s] が作成できませんでした。",
	'The blog\'s media directory [%s] has been created with permissions %s.' => "ブログのメディア ディレクトリ [%s] を権限 %s で作成しました。",
	...
	'MS Vb script' => "MS Vbスクリプト",
	'Document' => "ドキュメント",
	'XML file' => "XMLファイル",
	'Zip Archive' => "Zipアーカイブ",
	'unknown' => "不明",
	'&lt;dir&gt;' => "&lt;dir&gt;",
	'Cannot open directory [%s]!' => "ディレクトリ [%s] が開けません!",
	'regular expression' => "正規表現",
	'No access to root directory.' => "ルート ディレクトリへのアクセスがありません。",
	'The root directory [%s] does not exist.' => "ルートディレクトリ [%s] は存在しません。",
	'You are not allowed to go outside your root directory!' => "あなたのルートディレクトリ外に移動することは許可されていません!",
	'The directory [%s] does not exist.' => "ディレクトリ [%s] は存在しません。",
	'The filter [%s] is not a regular expression.' => "フィルタ [%s] は正規表現ではありません。",
	'Edit permissions' => "権限編集",
	'Upload a file/image' => "ファイル/画像をアップロードする",
	'My media folder' => "私のメディア フォルダ",
	'Sort ascending by this column' => "この欄で昇順ソート",
	'Sort descending by this column' => "この欄で降順ソート",
	'File [%s] not found.' => "ファイル [%s] が見つかりません。",
	'Directory [%s] and subdirectories deleted.' => "ディレクトリ [%s] とサブディレクトリを削除しました。",
	'Directory [%s] could not be deleted.' => "ディレクトリ [%s] が削除できません。",
	'Directory [%s] deleted.' => "ディレクトリ [%s] を削除しました。",
	'Directory [%s] could not be deleted (probably not empty).' => "ディレクトリ [%s] は削除できませんでした (たぶん空ではありません)。",
	'File [%s] deleted.' => "ファイル [%s] を削除しました。",
	'File [%s] could not be deleted.' => "ファイル [%s] は削除できませんでした。",
	'Cannot create empty directory.' => "空のディレクトリを作成できません。",
	'Cannot create empty file.' => "空のファイルを作成できません。",
	'[%s] is not a valid directory.' => "[%s] は有効なディレクトリではありません。",
	'File [%s] has been created.' => "ファイル [%s] が作成されました。",
	'Directory [%s] has been created.' => "ディレクトリ [%s] が作成されました。",
	'Could not create file [%s] in [%s].' => "ファイル [%s] を [%s] 内に作成できません。",
	'Could not create directory [%s] in [%s].' => "ディレクトリ [%s] を [%s] 内に作成できません。",
	...
	'$prev$ page $page$/$total_pages$ $next$' => "\$prev\$ ページ \$page\$/\$total_pages\$ \$next\$",
	'No results.' => "結果がありません。",
	'Archives for' => "アーカイブ",
	...
	'Please enter the new password twice.' => "新しいパスワードを2度入力してください。",
	...
	'Adds all external links to the blog\'s Autolinkblog' => "すべての外部へのリンクにAutolinkblogを追加",
