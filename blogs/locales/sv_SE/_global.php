...
$trans['sv_SE'] = array(
	...
	'Note: Moving categories across blogs is disabled.' => "OBS: Funktionen för korspostning mellan olika bloggar är på.",
	...
	'Saved locale \'%s\'.' => "Uppdatera språkfilen '%s'.",
	...
	'Supplied content is invalid' => "Denna URL är felaktig: ",
	...
	'Other blog through stub file (Advanced)' => "Annan blogg på stubbfilen",
	'You MUST create a stub file for this to work.' => "Du har inte angett något statiskt filnamn för den här bloggen.",
	...
	'e - day of the week, 1 letter; i.e. "F"' => "D - veckodag, textform, tre bokstäver; t.ex. \"Fre\"",
	...
	'Member' => "Medlem",
	'Visitor' => "Besökare",
	'Edit this comment' => "Redigera kommentar",
	'Delete' => "Radera",
	'Delete this comment' => "Redigera kommentar",
	...
	'Danish (DK)' => "Engelska (UK)",
	'German (DE)' => "Tyska (DE)",
	'English (EU)' => "Engelska (EU)",
	'English (UK)' => "Engelska (UK)",
	'English (US)' => "Engelska (US)",
	'English (CA)' => "Engelska (EU)",
	'English (AU)' => "Engelska (EU)",
	'English (IL)' => "Engelska (EU)",
	'English (NZ)' => "Engelska (EU)",
	'English (SG)' => "Engelska (US)",
	'Spanish (ES)' => "Spanska (ES)",
	'Spanish (MX)' => "Spanska (ES)",
	'Spanish (VE)' => "Spanska (ES)",
	'Finnish (FI)' => "Engelska (EU)",
	'French (FR)' => "Franska (FR)",
	'French (CA)' => "Franska (FR)",
	'French (BE)' => "Franska (FR)",
	'Galician (ES)' => "Italienska (IT)",
	'Italian (IT)' => "Italienska (IT)",
	'Japanese (JP)' => "Japanska (JP)",
	'Lithuanian (LT)' => "Litauiska (LT)",
	'Bokm&aring;l (NO)' => "Bokmål (NO)",
	'Dutch (NL)' => "Holländska (NL)",
	'Dutch (BE)' => "Holländska (NL)",
	...
	'Supplied name is invalid' => "Denna URL är felaktig: ",
	...
	'Supplied comment is invalid' => "Denna URL är felaktig: ",
	'You can only post a new comment every %d seconds.' => "Du kan bara posta en kommentar en gång var 30:e sekund.",
	...
	'You cannot reset this account in demo mode.' => "Du kan inte ändra demo-användarens profil när du är i demo-läge.",
	...
	'<strong>Upgrade from Manywhere Miniblog</strong>: Install b2evolution database tables and copy your existing Miniblog data into them.' => "<strong>Uppgradera från Cafelog/b2 v 0.6.x</strong>: Installera b2evolutions databastabeller och kopiera över befintlig Cafelog/b2-data.",
	'<strong>Upgrade from WordPress v 1.2</strong>: Install b2evolution database tables and copy your existing WordPress data into them.' => "<strong>Uppgradera från Cafelog/b2 v 0.6.x</strong>: Installera b2evolutions databastabeller och kopiera över befintlig Cafelog/b2-data.",
	...
	'Installing b2evolution tables and copying existing %s data' => "Installerar b2evolution-tabeller och kopierar befintliga b2-data",
	...
	'official website' => "officiell hemsida",
	'contact' => "kontakt",
	'This blog holds all your posts upgraded from Cafelog. This blog is named \'%s\'. %s' => "Denna blogg innehåller alla dina inlägg från Cafelog. Denna blogg heter '%s'. Den har index #%d i databasen. Den förvalda stubbfilen heter '<code>%s</code>'. %s",
	...
	'**bold** \\italics\\ //italics// __underline__ ##tt## %%codeblock%%' => "**bold** \\italics\\ //italics// __underline__ måste föregås av blanktecken.",
	'Convert text smilies to icons' => "Konvertera text-smilies till ikoner",
	'Wacko style formatting' => "Datumformat",
	...
	'Filed under:' => "Ladda upp fil",
	'Other' => "Oktober",
	'Syndicate this site using RSS' => "Syndikera denna blogg",
	'Powered by b2evolution; multilingual multiuser multi-blog engine.' => "Multiblogg för multianvändare på multipla språk",
	'[...] Read more!' => "[...] Läs mer!",
