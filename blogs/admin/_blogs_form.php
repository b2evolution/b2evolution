<?php 
	...
	{
		case 'create':
			$submit = _('Create new blog!');
			break;
			
		case 'update':
			$submit = _('Update blog!');
			break;
	}
?>
<form class="fform" method="post">
	...
	<fieldset>
		<div class="label"><label for="blog_name"><?php echo _('Full Name') ?>:</label></div> 
		<div class="input"><input type="text" name="blog_name" id="blog_name" size="50" maxlength="50" value="<?php echo $blog_name ?>" /></div>
	</fieldset>

	<fieldset>
		<div class="label"><label for="blog_shortname"><?php echo _('Short Name') ?>:</label></div> 
	...
	<fieldset>
		<div class="label"><label for="blog_tagline"><?php echo _('Tagline') ?>:</label></div>
		...
		<span class="notes"><?php echo _('This is diplayed under the blog name on the blog template') ?></span></div>
	</fieldset>
	
	<fieldset>
		<div class="label"><label for="blog_description"><?php echo _('Short Description') ?>:</label></div> 
		...
		<span class="notes"><?php echo _('This is is used in meta tag description and RSS feeds. NO HTML!') ?></span></div>
	</fieldset>

	<fieldset>
		<div class="label"><label for="blog_keywords"><?php echo _('Keywords') ?>:</label></div> 
		...
		<span class="notes"><?php echo _('This is is used in meta tag keywords. NO HTML!') ?></span></div>
	</fieldset>
	
	<fieldset>
		<div class="label"><label for="blog_longdesc" ><?php echo _('Long Description') ?>:</label></div> 
		<div class="input"><textarea name="blog_longdesc" id="blog_longdesc" rows="3" cols="50" class="large"><?php echo $blog_longdesc ?></textarea>
		<span class="notes"><?php echo _('This is displayed on the blog template.') ?></span></div>
	</fieldset>
	
	<fieldset>
		<div class="label"><label for="blog_roll" ><?php echo _('Blogroll') ?>:</label></div> 
		<div class="input"><textarea name="blog_roll" id="blog_roll" rows="10" cols="50" class="large"><?php echo $blog_roll ?></textarea>
		<span class="notes"><?php echo _('This is displayed on the blog template.') ?></span></div>
	</fieldset>
	
	<fieldset>
		<div class="label"><label for="blog_lang"><?php echo _('Main Language') ?>:</label></div> 
		<div class="input"><select name="blog_lang" id="blog_lang"><?php lang_options( $blog_lang )?></select></div>
	</fieldset>
	
	<fieldset>
		<div class="label"><label for="blog_siteurl"><?php echo _('Site URL') ?>: </label></div> 
		...
		<span class="notes"><?php echo _('This is the URL to the directory where the <em>Stub filename</em> and <em>Static filename</em> files live.') ?></span></div>
	</fieldset>
	
	<fieldset>
		<div class="label"><label for="blog_filename"><?php echo _('Stub Filename') ?>:</label></div> 
		<div class="input"><input type="text" name="blog_filename" id="blog_filename" size="30" maxlength="30" value="<?php echo $blog_filename ?>" />
		<span class="notes"><?php echo _('This is the <strong>file</strong>name of the main file (e-g: blog_b.php) used to display this blog. This is used mainly for static page generation, but setting this incorrectly may also cause navigation to fail.') ?></span></div>
	</fieldset>

	<fieldset>
		<div class="label"><label for="blog_stub"><?php echo _('Stub Urlname') ?>:</label></div> 
		<div class="input"><input type="text" name="blog_stub" id="blog_stub" size="30" maxlength="30" value="<?php echo $blog_stub ?>" />
		<span class="notes"><?php echo _('This is the <strong>url</strong>name of the main file (e-g: blog_b.php) used to display this blog. A typical setting would be setting this to your Filename without the .php extension, if your webserver supports this. <strong>If you are not sure how to set this, use the same as Stub Filename.</strong> This is used by permalinks, trackback, pingback, etc. Setting this incorrectly may cause these to fail.') ?></span></div>
	</fieldset>
	...
	<fieldset>
		...
		<span class="notes"><?php echo _('This is the filename that will be used when you generate a static (.html) version of the blog homepage.') ?></span></div>
	</fieldset>
