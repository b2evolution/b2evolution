...
switch( $AdminUI->getPath(1) )
{
	case 'summary':
		...
		case 'referers':
			...
			<?php refererList(30,'global',0,0,"'no'",'dom_name',$blog,true);
			if( count( $res_stats ) )
			{
				$chart [ 'chart_data' ][ 0 ][ 0 ] = "";
		...
		case 'refsearches':
			...
			<?php refererList(20,'global',0,0,"'search'",'dom_name',$blog,true);
			if( count( $res_stats ) )
			{ ?>
			<table class="grouped" cellspacing="0">
				<?php
			...
			<?php refererList(20,'global',0,0,"'robot'",'agnt_signature',$blog,true,true);
			if( count( $res_stats ) )
			{ ?>
			<table class="grouped" cellspacing="0">
				<?php
