...
<div class="bSideItem">
    ...
    <h3>Misc</h3>
		<ul>  
			<li><a href="<?php echo $pathserver?>/admin/b2login.php">Login</a> </li>
			<li><a href="<?php echo $pathserver?>/admin/b2register.php">Register</a></li>
		</ul>	
	</div>

	<div class="bSideItem">
    <h3>Syndicate this blog <img src="<?php echo $baseurl; ?>/img/xml.gif" alt="XML" width="36" height="14" class="middle" /></h3>
