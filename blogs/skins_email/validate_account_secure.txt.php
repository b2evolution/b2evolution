<?php
/**
 * This is the PLAIN TEXT template of email message for validate user account (Secure mode)
 *
...
echo $secure_htsrv_url.'login.php?action=validatemail'.$params['blog_param'].'&reqID='.$params['request_id'].'&sessID='.$Session->ID; // used to detect cookie problems
echo "\n\n";
