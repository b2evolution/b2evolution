...
{ // Display lost password form footer
	echo '<div class="notes standard_login_link"><a href="'.get_htsrv_url( 'login' ).'login.php?action=lostpassword&amp;source='.rawurlencode( $source ).'&amp;redirect_to='.rawurlencode( $redirect_to ).'&amp;return_to='.rawurlencode( $return_to ).'">'.T_( 'Use basic password recovery form instead').' &raquo;</a></div>';
