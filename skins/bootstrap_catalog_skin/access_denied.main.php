...
{ // Display 'Menu' widget container
	...
	widget_container( 'menu', array(
			...
			'container_start'     => '<nav class="row"><div class="col-mod-12"><ul class="nav nav-tabs evo_container $wico_class$">',
	...
	<div class="col-md-12 center">
		...
		{ // Display 'Footer' widget container
			widget_container( 'footer', array(
					// The following params will be used as defaults for widgets included in this container:
					'container_display_if_empty' => false, // If now widget, don't display container at all
