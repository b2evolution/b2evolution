...
'You already registered on this site. You can <a %s>log in here</a>. If you don\'t know it or have forgotten it, you can <a %s>reset your password here</a>.' => 'Sie haben sich bereits auf dieser Webseite registriert. Sie können sich hier <a %s>einloggen</a>. Wenn Sie es nicht kennen oder vergessen haben, können Sie Ihr <a %s>Passwort hier zurücksetzen</a>.',
...
' Also delete files that will no longer be referenced in the destination collection after replacing its contents' => 'Löschen Sie auch Dateien, auf die in der Zielsammlung nach dem Ersetzen des Inhalts nicht mehr verwiesen wird',
...
'# of hashes by default' => '# von Hashes standardmäßig',
'# of hashes for anonymous users from suspect countries' => '# von Hashes für anonyme Benutzer aus verdächtigen Ländern',
'# of hashes for suspect users' => '# von Hashes für verdächtige Benutzer',
