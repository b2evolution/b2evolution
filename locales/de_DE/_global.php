...
'IMAP extension is NOT loaded! ' => 'IMAP-Erweiterung ist NICHT geladen!',
'Connecting and authenticating to mail server %s' => 'Verbindung und Authentifizierung mit Mail-Server %s',
...
'Ignoring this message because it has aleady been read.' => 'Die Nachricht wird ignoriert, da sie bereits gelesen wurde.',
'Could not create temporary file.' => 'Temporäre Datei konnte nicht erzeugt werden.',
'MIME message decoding error: %s at position %d.' => 'MIME Nachrichten-Decodierungsfehler: %s an Position %d.',
'MIME message decoding successful' => 'MIME Nachrichten-Decodierung erfolgreich',
'MIME message analyze error: %s' => 'MIME Nachrichtenanalyse-Fehler: %s',
'Email Type' => 'E-Mail-Typ',
'HTML message part saved as %s' => 'HTML Nachrichtenteil gespeichert als %s',
'HTML alternative message part saved as %s' => 'HTML alternativer Nachrichtenteil gespeichert als %s',
'Text alternative message part saved as %s' => 'Text alternativer Nachrichtenteil gespeichert als %s',
'Plain-text message part saved as %s' => 'Normaler Text-Nachrichtenteil gespeichert als %s',
'%d warnings during decode:' => '%d Warnungen während der Decodierung:',
'Warning: %s at position %s' => 'Warnung: %s auf Position %s',
'Message type: %s' => 'Nachrichten-Typ: %s',
'Message body: %s' => 'Nachrichtentext: %s',
'Message body (original): %s' => 'Nachrichtentext (original): %s',
'Message body (processed): %s' => 'Nachrichtentext (verarbeitet): %s',
'MIME Decoding Successful' => 'MIME Decodierung erfolgreich',
'Processing message: %s' => 'Verarbeite Nachricht: %s',
'Cannot post, please correct these errors:' => 'Eintragen nicht möglich. Bitte korrigieren Sie die folgenden Fehler:',
'Saving the returned email in the database' => 'Die zurückgesendete E-Mail wird in der Datenbank gespeichert',
'Email Address' => 'E-Mail-Adresse',
'Error Type' => 'Fehlertyp',
'Error Message' => 'Fehlermeldung',
'Marking message for deletion from inbox: %s' => 'Die Nachricht wird zum Löschen aus dem Posteingang markiert: %s',
'Working with message %s:' => 'Arbeite mit Nachricht: %s',
'(No MIME decoding is done in simulation mode)' => '(Im Simulationsmodus wird keine MIME Decodierung durchgeführt)',
'Subject' => 'Betreff',
'Subject prefix is not "%s", skip this email' => 'Betreff-Prefix ist nicht "%s", überspringe diese E-Mail',
...
'Attachment: %s stored as %s' => 'Anhang: %s abgelegt als %s',
'Related file with content ID: %s stored as %s' => 'Verwandte Datei mit Inhalts-ID: %s abgelegt als %s',
...
'Authenticating user' => 'Benutzer-Authentifizierung',
'Authentication failed for user &laquo;%s&raquo;' => 'Authentifizierung für den Benutzer &laquo;%s&raquo; fehlgeschlagen',
'Success' => 'Erfolgreich',
'Extra categories' => 'Zusätzliche Kategorien',
'Main category ID' => 'Hauptkategorie-ID',
...
'Checking permissions for user &laquo;%s&raquo; to post to Blog #%d' => 'Überprüfe Berechtigungen für Benutzer &laquo;%s&raquo; für Einträge auf Blog #%d',
...
'Applying the following text renderers: %s' => 'Anwendung der folgenden Text-Renderer: %s',
'Filtered post content: %s' => 'Gefilterter Eintragsinhalt: %s',
'It looks like the post can be successfully saved in the database. However we will not do it in test mode.' => 'Es sieht so aus als könne der Eintrag erfolgreich in der Datenbank gespeichert werden. Jedoch tun wir dies im Testmodus nicht.',
'Saving item "%s" in the database' => 'Element "%s" wird in der Datenbank gespeichert',
'Item created?: %s' => 'Element erstellt?: %s',
'Saving file "%s" in the database' => 'Speichern der Datei "%s" in der Datenbank',
'File saved?: %s' => 'Datei gespeichert?: %s',
'Attaching file "%s" to the post' => 'Datei "%s" wird an den Eintrag angehängt',
'File attached?: %s' => 'Datei angehängt?: %s',
'Message posting successful' => 'Nachricht erfolgreich eingetragen',
'Processing attachments' => 'Anhänge werden verarbeitet',
'Attachment without name. Using "%s".' => 'Anhang ohne Namen. "%s" wird verwendet.',
'Invalid filename' => 'Ungültiger Dateiname',
'New file name is %s' => 'Neuer Dateiname ist %s',
'Saving file to: %s' => 'Speichere Datei in: %s',
'Unable to copy uploaded file to %s' => 'Kopieren der hochgeladenen Datei nach "%s" nicht möglich',
'Is this an image?: %s' => 'Ist dies ein Bild?: %s',
'The file %s will be attached to the post later, after we save the post in the database.' => 'Die Datei %s wird dem Eintrag später angehängt, nachdem wir den Eintrag in der Datenbank speichern.',
