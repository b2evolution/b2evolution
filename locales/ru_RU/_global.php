...
'Edit in Front-Office' => 'Редактировать в Публичной Части',
...
'Registered from' => 'Зарегистрирован из',
...
'Display Item' => 'Показывать Запись',
...
'Newsletter/Email list subscription' => 'Подписка на рассылку/email список',
...
'Get our list!' => 'Получите наш список!',
...
'Proof of Work Captcha' => 'Каптча Доказательства Работы',
'API site key' => 'API ключ сайта',
'Site Key (public)' => 'Ключ Сайта (публичный)',
'Use "%s" which is generated for your site on <a %s>%s</a>' => 'Использовать "%s", который сгенерирован для вашего сайта на <a %s>%s</a>',
'API secret key' => 'API секретный ключ',
'Secret Key (private)' => 'Секретный Ключ (личный)',
'Number of hashes' => 'Количество хешей',
'To enable this plugin you should enter API keys!' => 'Чтобы включить этот плагин, вы должны ввести API ключи!',
'Captcha has not been verified successfully!' => 'Каптча не была проверена успешно!',
'Loading Captcha...<br>If it doesn\'t load, please disable Adblock!' => 'Загрузка Каптчи...<br>Если не загружается, пожалуйста отключите Adblock!',
...
'If you don\'t want to receive this list anymore, click here:' => 'Если вы не хотите больше получать список, кликните сюда:',
