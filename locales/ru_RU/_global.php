...
'Preferred contact method' => 'Предпочитаемый метод контакта',
...
'Name input for logged in users' => 'Имя ввода для залогиненных пользователей',
...
'Please configure an API key to see a live map.' => 'Пожалуйста, настройке API ключ, чтобы смотреть карту.',
