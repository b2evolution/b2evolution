...
'You can review the SEO settings recommended by <strong>%s</strong> below. Click the "Save Changes!" button to apply these settings.' => 'Вы можете изменить настройки SEO, рекомендованные <strong>%s</strong> ниже. Нажмите "Сохранить" когда закончите.',
