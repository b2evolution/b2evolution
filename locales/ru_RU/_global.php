...
'Drafts' => 'Черновики',
'Any' => 'Любой',
'Add an advertisement...' => 'Добавить объявление...',
...
'Click on link %s icons below to link additional files to <strong>Comment</strong>.' => 'Нажимайте на иконки связок %s ниже, чтобы привязать дополнительные файлы к <strong>Комментарию</strong>.',
...
'Click on link %s icons below to link additional files to <strong>item</strong>.' => 'Нажимайте на иконки связок %s ниже, чтобы привязать дополнительные файлы к <strong>Записи</strong>.',
...
'Click on link %s icons below to link additional files to <strong>user</strong>.' => 'Нажимайте на иконки связок %s ниже, чтобы привязать дополнительные файлы к <strong>пользователю</strong>.',
...
'Messaging emails link to' => 'Ссылка на сообщения из email ведет в',
...
'Session Timeouts' => 'Время окончания сессии',
...
'Welcome to Blog A' => 'Добро пожаловать в Блог А',
