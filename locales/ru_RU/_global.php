...
'IMAP extension is NOT loaded! ' => 'Расширение IMAP не загружено!',
'Connecting and authenticating to mail server %s' => 'Соединение и аутентификация на почтовом сервере %s',
'Connection failed: %s' => 'Ошибка соединения: %s',
'Successfully connected!' => 'Успешно подключилось!',
'Processing message %s:' => 'Обработка сообщения %s:',
'Ignoring this message because it has aleady been read.' => 'Игнорировать это сообщение, потому что оно уже было прочитано.',
'Could not create temporary file.' => 'Невозможно создать временный файл.',
'MIME message decoding error: %s at position %d.' => 'Ошибка декодирования MIME сообщения: %s на позиции %d.',
'MIME message decoding successful' => 'Декодирование MIME сообщения прошло успешно',
'MIME message analyze error: %s' => 'Ошибка анализирования MIME сообщения: %s',
'Email Type' => 'Email Тип',
'HTML message part saved as %s' => 'Часть HTML сообщения сохранена как %s',
'HTML alternative message part saved as %s' => 'Альтернативная часть HTML сообщения сохранена как %s',
'Text alternative message part saved as %s' => 'Альтернативная текстовая часть сообщения сохранена как %s',
'Plain-text message part saved as %s' => 'Текстовая часть сообщения сохранена как %s',
'%d warnings during decode:' => '%d предупреждений во время декодирования:',
'Warning: %s at position %s' => 'Предупреждение: %s на позиции %s',
'Message type: %s' => 'Тип сообщения: %s',
'Message body: %s' => 'Тело сообщения: %s',
'Message body (original): %s' => 'Тело сообщения (оригинал): %s',
'Message body (processed): %s' => 'Тело сообщения (обработанное): %s',
'MIME Decoding Successful' => 'MIME декодирование прошло успешно',
...
'Saving the returned email in the database' => 'Сохранение возвращенных сообщений в базе данных',
'Email Address' => 'Email адрес',
'Error Type' => 'Тип ошибки',
'Error Message' => 'Ошибочное Сообщение',
'Marking message for deletion from inbox: %s' => 'Пометить сообщение для удаления из почтового ящика: %s',
'Working with message %s:' => 'Работа с сообщением %s:',
'(No MIME decoding is done in simulation mode)' => '(MIME декодирование не выполняется в режиме симулирования)',
'Subject' => 'Тема',
'Subject prefix is not "%s", skip this email' => 'Префикс темы не "%s", пропустить это сообщение',
...
'Attachment: %s stored as %s' => 'Вложение: %s сохранено как %s',
'Related file with content ID: %s stored as %s' => 'Связанный файл с ID содержимым: %s сохранен как %s',
...
'Authenticating user' => 'Аутентификационный пользователь',
'Authentication failed for user &laquo;%s&raquo;' => 'Ошибка аутентификации для пользователя &laquo;%s&raquo;',
'Success' => 'Успешно',
'Extra categories' => 'Расширенные рубрики',
'Main category ID' => 'ID основной рубрики',
...
'Checking permissions for user &laquo;%s&raquo; to post to Blog #%d' => 'Проверка разрешений пользователя &laquo;%s&raquo; для записи Блога #%d',
...
'Applying the following text renderers: %s' => 'Применение следующих текстовых обработчиков: %s',
'Filtered post content: %s' => 'Отфильтрованное содержимое сообщения: %s',
'It looks like the post can be successfully saved in the database. However we will not do it in test mode.' => 'Похоже эта запись может быть успешно сохранена в базе данных. Однако, мы не сделаем это в тестовом режиме.',
'Saving item "%s" in the database' => 'Сохранение записи "%s" в базе данных',
'Item created?: %s' => 'Запись создана?: %s',
'Saving file "%s" in the database' => 'Сохранение файла "%s" в базе данных',
'File saved?: %s' => 'Файл сохранен?: %s',
'Attaching file "%s" to the post' => 'Прикрепление файла "%s" к записи',
'File attached?: %s' => 'Файл прикреплен?: %s',
'Message posting successful' => 'Публикация сообщения прошла успешно',
'Processing attachments' => 'Обработка вложений',
'Attachment without name. Using "%s".' => 'Вложение без имени. Используется "%s".',
'Invalid filename' => 'Недопустимое имя файла',
'New file name is %s' => 'Имя нового файла - %s',
'Saving file to: %s' => 'Сохранение файла в: %s',
'Unable to copy uploaded file to %s' => 'Невозможно скопировать загружаемый файл в %s',
'Is this an image?: %s' => 'Это изображение?: %s',
'The file %s will be attached to the post later, after we save the post in the database.' => 'Файл %s будет прикреплен к записи позже, после того как мы сохраним запись в базе данных.',
