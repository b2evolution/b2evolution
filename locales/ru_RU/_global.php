...
'Please select option of "New contents"' => 'Пожалуйста, выберите опцию "Нового содержимого"',
...
'Stale content alert must be a number of months.' => 'Оповещение об устаревшем контенте должно быть числом месяца.',
