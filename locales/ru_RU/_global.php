...
'Server error. Increase post_max_size and upload_max_filesize to %s' => 'Ошибка сервера. Увеличьте post_max_size и upload_max_filesize до %s',
'No file was uploaded.' => 'Файлы не были загружены.',
'Server error. Not a multipart request. Please set forceMultipart to default value (true).' => 'Ошибка сервера. Не многопрофильный запрос. Установите значение forceMultipart в значение по умолчанию (true).',
...
'Server error. Chunks directory isn\'t writable or executable.' => 'Ошибка сервера. Каталог не доступен для записи или для исполнения.',
'Server error. Uploads directory isn\'t writable' => 'Ошибка сервера. Каталог загрузки не доступен для записи',
...
'"Contents last updated" timestamp has been refreshed.' => 'Значение "Последний обновленный контент" было обновлено.',
...
'Wrong selected item for merging, please try again.' => 'Неправильно выбранная запись для объединения, пожалуйста попробуйте еще раз.',
...
'%s Likes' => '%s Лайков',
'No likes' => 'Нет лайков',
'Refresh "contents last updated" timestamp!' => 'Обновить значение "Последний обновленный контент"!',
...
'Display date and time when item/post contents (title, content, URL or attachments) were last updated' => 'Показывать дату и время, когда содержимое(заголовок, содержимое, ссылка или вложения) записи было обновлено в последний раз',
...
'Create sample private messages between users' => 'Создать тестовые личные сообщения между пользователями',
...
'Facebook Widget' => 'Facebook Виджет',
'This widget displays Facebook Like and Share buttons.' => 'Этот виджет показывает кнопку "Нравится" или "Поделиться" от Facebook.',
'Also shows how many users liked and shared the current page.' => 'Также показывать скольким пользователям нравится текущая страница и кто ей поделился.',
'Buttons to show' => 'Кнопки для показа',
'Like' => 'Нравится',
'Share' => 'Поделиться',
'standard' => 'стандартный',
'box with count' => 'блок с количеством',
'button with count' => 'кнопка с количеством',
'button' => 'кнопка',
...
'small' => 'маленький',
'large' => 'большой',
'Show friend\'s faces' => 'Показывать лица друзей',
'Show profile photos when 2 or more friends like this' => 'Показывать фото профилей, когда это понравилось 2 и более друзьям',
