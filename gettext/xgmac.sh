...
xgettext -D ../blogs/ -f files.txt --package-version=5 --no-wrap --add-comments=TRANS --copyright-holder="Francois Planque" --msgid-bugs-address=http://fplanque.net/ -o messages.pot --keyword=T_ --keyword=NT_ --keyword=TS_ --package-name=b2evolution --sort-by-file
...
#sed -i .bak s/YEAR/2013/ ../blogs/locales/messages.pot
