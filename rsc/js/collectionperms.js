...
function toggleall_perm( the_form, id, set )
{
	...
	var options = new Array(
			"blog_ismember_", "blog_can_be_assignee_", "blog_perm_item_propose_", "blog_perm_published_", "blog_perm_community_", "blog_perm_protected_", "blog_perm_private_", "blog_perm_review_", "blog_perm_draft_", "blog_perm_deprecated_", "blog_perm_redirected_", "blog_perm_meta_comment_", "blog_perm_page_", "blog_perm_intro_", "blog_perm_podcast_", "blog_perm_sidebar_", "blog_perm_delpost_", "blog_perm_edit_ts_",
