tinymce.PluginManager.add( 'b2evo_shorttags', function( editor ) {
	var win;
	var tags = {};
	console.log( 'Short Tags initialized' );
			...
			for( var i = 0; i < n; i++ )
			{
				...
				if( typeof tags[matches[i].shortTag] !== undefined ) {
					switch( matches[i].inlineType )	{
						...
						default:
							content = content.replace( matches[i].shortTag, '<span style="color: green;" data-b2evo-shorttag="' + data + '">' + matches[i].shortTag + '</span>' );
					}
				}	else {
