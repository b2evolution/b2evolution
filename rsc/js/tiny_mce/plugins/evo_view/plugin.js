...
tinymce.PluginManager.add( 'evo_view', function( editor ) {
	...
	*/
	...
	editor.on( 'NodeChange', function( event ) {
		...
		if ( focus && view ) {
			if ( ( className === 'evo-view-selection-before' || className === 'evo-view-selection-after' ) &&
	...
	editor.on( 'BeforeExecCommand', function() {
		...
		if ( node && ( ( execCommandBefore = node.className === 'evo-view-selection-before' ) || node.className === 'evo-view-selection-after' ) && ( view = getView( node ) ) ) {
