...
jQuery( document ).ready( function()
{
	...
	var config = evo_init_inlines_toolbar_config;
	...
	if( typeof( evo_init_inlines_toolbar ) != 'undefined' )
	{	// Init individual shortlinks toolbar:
		var inlines_toolbars = Object.values( evo_init_inlines_toolbar );
		for( var i = 0; i < inlines_toolbars.length; i++ )
		{
			window.inline_toolbar( inlines_toolbars[i]['title'], inlines_toolbars[i]['prefix'] );
		}
	}
