...
tinymce.PluginManager.add('image', function(editor) {
	...
	editor.addButton('image', {
		...
		onPostRender: function() {
			var button = this;
			var shortTags = editor.plugins.b2evo_shorttags;

			if( shortTags ) {

				editor.on( 'NodeChange', function( event ) {
					var node = editor.selection.getNode();
					var selected = shortTags.selected();
					...
					button.active( !selected && editor.dom.is( node, 'img:not([data-mce-object],[data-mce-placeholder]),figure.image' ) );

				} );
			}	else {
				this.stateSelector = 'img:not([data-mce-object],[data-mce-placeholder]),figure.image';
			}
