...
$params = array_merge( array(
		...
		'search_author'              => true,
		'search_age'                 => true,
		'search_input_author_before' => '<div class="form-inline"><div class="form-group"><label for="$for$">$label$:</label> ',
		'search_input_author_after'  => '</div> ',
		'search_input_age_before'    => '<div class="form-group"><label for="$for$">$label$:</label> ',
		'search_input_age_after'     => '</div></div>',
