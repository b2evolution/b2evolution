...
{ // Display lost password form footer
	echo '<div class="evo_login_dialog_standard_link"><a href="'.get_htsrv_url( true ).'login.php?action=lostpassword&amp;source='.rawurlencode( $source ).'&amp;redirect_to='.rawurlencode( $redirect_to ).'&amp;return_to='.rawurlencode( $return_to ).'">'.T_( 'Use standard password recovery form instead').' &raquo;</a></div>';
