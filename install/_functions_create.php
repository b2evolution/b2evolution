...
function create_default_currencies( $table_name = 'T_regional__currency' )
{
	...
	$DB->query( "
		INSERT INTO $table_name (curr_code, curr_shortcut, curr_name, curr_default)
		 VALUES
			('AFN', '&#x60b;', 'Afghani', 0),
			('EUR', '&euro;', 'Euro', 0),
			('ALL', 'Lek', 'Lek', 0),
			('DZD', 'DZD', 'Algerian Dinar', 0),
			('USD', '$', 'US Dollar', 1),
			('AOA', 'AOA', 'Kwanza', 0),
			('XCD', '$', 'East Caribbean Dollar', 0),
			('ARS', '$', 'Argentine Peso', 0),
			('AMD', 'AMD', 'Armenian Dram', 0),
			('AWG', '&fnof;', 'Aruban Guilder', 0),
			('AUD', '$', 'Australian Dollar', 0),
			('AZN', '&#x43c;&#x430;&#x43d;', 'Azerbaijanian Manat', 0),
			('BSD', '$', 'Bahamian Dollar', 0),
			('BHD', 'BHD', 'Bahraini Dinar', 0),
			('BDT', 'BDT', 'Taka', 0),
			('BBD', '$', 'Barbados Dollar', 0),
			('BYR', 'p.', 'Belarussian Ruble', 0),
			('BZD', 'BZ$', 'Belize Dollar', 0),
			('XOF', 'XOF', 'CFA Franc BCEAO', 0),
			('BMD', '$', 'Bermudian Dollar', 0),
			('BAM', 'KM', 'Convertible Marks', 0),
			('BWP', 'P', 'Pula', 0),
			('NOK', 'kr', 'Norwegian Krone', 0),
			('BRL', 'R$', 'Brazilian Real', 0),
			('BND', '$', 'Brunei Dollar', 0),
			('BGN', '&#x43b;&#x432;', 'Bulgarian Lev', 0),
			('BIF', 'BIF', 'Burundi Franc', 0),
			('KHR', '&#x17db;', 'Riel', 0),
			('XAF', 'XAF', 'CFA Franc BEAC', 0),
			('CAD', '$', 'Canadian Dollar', 0),
			('CVE', 'CVE', 'Cape Verde Escudo', 0),
			('KYD', '$', 'Cayman Islands Dollar', 0),
			('CNY', '&yen;', 'Yuan Renminbi', 0),
			('KMF', 'KMF', 'Comoro Franc', 0),
			('CDF', 'CDF', 'Congolese Franc', 0),
			('NZD', '$', 'New Zealand Dollar', 0),
			('CRC', '&#x20a1;', 'Costa Rican Colon', 0),
			('HRK', 'kn', 'Croatian Kuna', 0),
			('CZK', 'K&#x10d;', 'Czech Koruna', 0),
			('DKK', 'kr', 'Danish Krone', 0),
			('DJF', 'DJF', 'Djibouti Franc', 0),
			('DOP', 'RD$', 'Dominican Peso', 0),
			('EGP', '&pound;', 'Egyptian Pound', 0),
			('ERN', 'ERN', 'Nakfa', 0),
			('EEK', 'EEK', 'Kroon', 0),
			('ETB', 'ETB', 'Ethiopian Birr', 0),
			('FKP', '&pound;', 'Falkland Islands Pound', 0),
			('FJD', '$', 'Fiji Dollar', 0),
			('XPF', 'XPF', 'CFP Franc', 0),
			('GMD', 'GMD', 'Dalasi', 0),
			('GEL', 'GEL', 'Lari', 0),
			('GHS', 'GHS', 'Cedi', 0),
			('GIP', '&pound;', 'Gibraltar Pound', 0),
			('GTQ', 'Q', 'Quetzal', 0),
			('GBP', '&pound;', 'Pound Sterling', 0),
			...
			('INR', 'Rs', 'Indian Rupee', 0),
			('IDR', 'Rp', 'Rupiah', 0),
			('IRR', '&#xfdfc;', 'Iranian Rial', 0),
			('IQD', 'IQD', 'Iraqi Dinar', 0),
			('ILS', '&#x20aa;', 'New Israeli Sheqel', 0),
			('JMD', 'J$', 'Jamaican Dollar', 0),
			('JPY', '&yen;', 'Yen', 0),
			('JOD', 'JOD', 'Jordanian Dinar', 0),
			('KZT', '&#x43b;&#x432;', 'Tenge', 0),
			('KES', 'KES', 'Kenyan Shilling', 0),
			('KPW', '&#x20a9;', 'North Korean Won', 0),
			('KRW', '&#x20a9;', 'Won', 0),
			('KWD', 'KWD', 'Kuwaiti Dinar', 0),
			('KGS', '&#x43b;&#x432;', 'Som', 0),
			('LAK', '&#x20ad;', 'Kip', 0),
			('LVL', 'Ls', 'Latvian Lats', 0),
			('LBP', '&pound;', 'Lebanese Pound', 0),
			('LRD', '$', 'Liberian Dollar', 0),
			('LYD', 'LYD', 'Libyan Dinar', 0),
			('CHF', 'CHF', 'Swiss Franc', 0),
			('LTL', 'Lt', 'Lithuanian Litas', 0),
			('MOP', 'MOP', 'Pataca', 0),
			('MKD', '&#x434;&#x435;&#x43d;', 'Denar', 0),
			('MGA', 'MGA', 'Malagasy Ariary', 0),
			('MWK', 'MWK', 'Kwacha', 0),
			('MYR', 'RM', 'Malaysian Ringgit', 0),
			('MVR', 'MVR', 'Rufiyaa', 0),
			('MRO', 'MRO', 'Ouguiya', 0),
			('MUR', 'Rs', 'Mauritius Rupee', 0),
			('MDL', 'MDL', 'Moldovan Leu', 0),
			('MNT', '&#x20ae;', 'Tugrik', 0),
			('MAD', 'MAD', 'Moroccan Dirham', 0),
			('MZN', 'MT', 'Metical', 0),
			('MMK', 'MMK', 'Kyat', 0),
			('NPR', 'Rs', 'Nepalese Rupee', 0),
			('ANG', '&fnof;', 'Netherlands Antillian Guilder', 0),
			('NIO', 'C$', 'Cordoba Oro', 0),
			('NGN', '&#x20a6;', 'Naira', 0),
			('OMR', '&#xfdfc;', 'Rial Omani', 0),
			('PKR', 'Rs', 'Pakistan Rupee', 0),
			('PGK', 'PGK', 'Kina', 0),
			('PYG', 'Gs', 'Guarani', 0),
			('PEN', 'S/.', 'Nuevo Sol', 0),
			('PHP', 'Php', 'Philippine Peso', 0),
			('PLN', 'z&#x142;', 'Zloty', 0),
			('QAR', '&#xfdfc;', 'Qatari Rial', 0),
			('RON', 'lei', 'New Leu', 0),
			('RUB', '&#x440;&#x443;&#x431;', 'Russian Ruble', 0),
			('RWF', 'RWF', 'Rwanda Franc', 0),
			('SHP', '&pound;', 'Saint Helena Pound', 0),
			('WST', 'WST', 'Tala', 0),
			('STD', 'STD', 'Dobra', 0),
			('SAR', '&#xfdfc;', 'Saudi Riyal', 0),
			('RSD', '&#x414;&#x438;&#x43d;.', 'Serbian Dinar', 0),
			('SCR', 'Rs', 'Seychelles Rupee', 0),
			('SLL', 'SLL', 'Leone', 0),
			('SGD', '$', 'Singapore Dollar', 0),
			('SBD', '$', 'Solomon Islands Dollar', 0),
			('SOS', 'S', 'Somali Shilling', 0),
			('ZAR', 'R', 'Rand', 0),
			('LKR', 'Rs', 'Sri Lanka Rupee', 0),
			('SDG', 'SDG', 'Sudanese Pound', 0),
			('SRD', '$', 'Surinam Dollar', 0),
			('SZL', 'SZL', 'Lilangeni', 0),
			('SEK', 'kr', 'Swedish Krona', 0),
			('SYP', '&pound;', 'Syrian Pound', 0),
			('TWD', '$', 'New Taiwan Dollar', 0),
			('TJS', 'TJS', 'Somoni', 0),
			('TZS', 'TZS', 'Tanzanian Shilling', 0),
			('THB', 'THB', 'Baht', 0),
			('TOP', 'TOP', 'Pa', 0),
			('TTD', 'TT$', 'Trinidad and Tobago Dollar', 0),
			('TND', 'TND', 'Tunisian Dinar', 0),
			('TRY', 'TL', 'Turkish Lira', 0),
			('TMT', 'TMT', 'Manat', 0),
			('UGX', 'UGX', 'Uganda Shilling', 0),
			('UAH', '&#x20b4;', 'Hryvnia', 0),
			('AED', 'AED', 'UAE Dirham', 0),
			('UZS', '&#x43b;&#x432;', 'Uzbekistan Sum', 0),
			('VUV', 'VUV', 'Vatu', 0),
			('VEF', 'Bs', 'Bolivar Fuerte', 0),
			('VND', '&#x20ab;', 'Dong', 0),
			('YER', '&#xfdfc;', 'Yemeni Rial', 0),
			('ZMK', 'ZMK', 'Zambian Kwacha', 0),
			('ZWL', 'Z$', 'Zimbabwe Dollar', 0),
			('XAU', 'XAU', 'Gold', 0),
			('XBA', 'XBA', 'EURCO', 0),
			('XBB', 'XBB', 'European Monetary Unit', 0),
			('XBC', 'XBC', 'European Unit of Account 9', 0),
			('XBD', 'XBD', 'European Unit of Account 17', 0),
			('XDR', 'XDR', 'SDR', 0),
			('XPD', 'XPD', 'Palladium', 0),
			('XPT', 'XPT', 'Platinum', 0),
			('XAG', 'XAG', 'Silver', 0),
			...
			('CUP', '$', 'Cuban peso', 0),
			('SVC', 'SVC', 'Salvadoran colon', 0),
			('CLP', '$', 'Chilean peso', 0),
			('HTG', 'G', 'Haitian gourde', 0),
			('MXN', '$', 'Mexican peso', 0),
			('PAB', 'PAB', 'Panamanian balboa', 0),
