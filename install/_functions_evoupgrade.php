...
// fp> TMP NOTE: This was current status of antispam
	...
	if( upg_task_start( 12840, 'Creating custom fields and link versions tables for item versions...' ) )
	{	// part of 6.9.3-beta
	...
	if( upg_task_start( 12850, 'Upgrading item versions tables...' ) )
	{	// part of 6.9.4
		$DB->query( 'ALTER TABLE T_items__version
	...
	if( upg_task_start( 12870, 'Upgrading links table...' ) )
	{	// part of 6.10.1-stable
