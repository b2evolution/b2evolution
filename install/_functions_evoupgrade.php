...
function upgrade_b2evo_tables( $upgrade_action = 'evoupgrade' )
{
	...
	*/
	...
	if( upg_task_start( 11780, 'Creating table for widget container...' ) )
	{	// part of 6.7.3-stable
	...
	if( upg_task_start( 11785, 'Inserting widget containers...' ) )
	{	// part of 6.7.3-stable
	...
	if( upg_task_start( 11790, 'Upgrading widgets table...' ) )
	{	// part of 6.7.3-stable
	...
	if( upg_task_start( 11795, 'Updating widget containers content...' ) )
	{	// part of 6.7.3-stable
	...
	if( upg_task_start( 11810, 'Rename widget "coll_avatar" to "user_profile_pics"...' ) )
	{	// part of 6.7.3-stable
		$DB->query( 'UPDATE T_widget__widget
