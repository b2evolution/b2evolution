...
function set_upgrade_checkpoint( $version )
{
	...
	{ // Max exe time not disabled and we're recahing the end
		$upgrade_action = ( ( $action == 'git_upgrade' ) || ( $action == 'auto_upgrade' ) ) ? $action : 'evoupgrade';
 ...
 *
 * @param string the action param value corresponding the current upgrade process ( evoupgrade, git_upgrade, auto_upgrade )
 */
