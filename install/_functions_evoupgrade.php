...
// fp> TMP NOTE: This was current status of antispam
	...
	if( upg_task_start( 13270, 'Upgrading widget containers and item types tables...' ) )
	{	// part of 7.0.0-alpha
		...
		db_add_col( 'T_items__type', 'ityp_page_container', 'TINYINT(1) DEFAULT 0 AFTER ityp_template_name' );
		// Insert default Item Type which items should be used for Page Containers:
		$widget_page_result = $DB->query( 'INSERT INTO T_items__type ( ityp_name, ityp_usage, ityp_template_name, ityp_page_container, ityp_use_text, ityp_use_coordinates, ityp_use_comments, ityp_perm_level )
			VALUES ( "Widget Page", "widget-page", "widget_page", 1, "never", "optional", 0, "admin")' );
