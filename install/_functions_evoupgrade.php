...
// fp> TMP NOTE: This was current status of antispam
	...
	if( upg_task_start( 16150, 'Creating table for item pricing...' ) )
	{	// part of 7.2.0-beta
	...
	if( upg_task_start( 16160, 'Upgrade table currencies...' ) )
	{	// part of 7.2.0-beta
	...
	if( upg_task_start( 16170, 'Installing new default widgets in container "Shopping Cart" and other new widgets for Catalog collection...' ) )
	{	// part of 7.2.0-beta
		install_new_default_widgets( 'shopping_cart' );
		install_new_default_widgets( 'item_single', 'subcontainer_row,item_custom_fields' );
		install_new_default_widgets( 'product_page_column_a' );
		install_new_default_widgets( 'product_page_column_b' );
		install_new_default_widgets( 'page_top', 'basic_menu_link' );
		upg_task_end();
	}

	if( upg_task_start( 16180, 'Upgrading items table...' ) )
	{	// part of 7.0.2-beta
		db_upgrade_cols( 'T_items__item', array(
			'ADD' => array(
	...
	if( upg_task_start( 16190, 'Upgrading item types table...' ) )
	{	// part of 7.2.0-beta
		db_upgrade_cols( 'T_items__type', array(
			'ADD' => array(
	...
	if( upg_task_start( 16200, 'Creating payment orders table...' ) )
	{	// part of 7.2.0-beta
	...
	if( upg_task_start( 16210, 'Creating orders and order items tables...' ) )
	{	// part of 7.2.0-beta
