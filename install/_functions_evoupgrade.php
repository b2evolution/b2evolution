...
function set_upgrade_checkpoint( $version )
{
	...
	echo '<span class="text-muted">Creating DB schema version checkpoint at '.$version.'... ';
	...
	echo "OK. (Elapsed upgrade time: $elapsed_time seconds)</span><br />\n";
...
function upgrade_b2evo_tables( $upgrade_action = 'evoupgrade' )
{
	...
	*/
	...
	if( upg_task_start( 11735, 'Create table for items votes...' ) )
	{	// part of 6.7.0
	...
	if( upg_task_start( 11740, 'Upgrade table posts for voting...' ) )
	{	// part of 6.7.0
		$DB->query( 'ALTER TABLE T_items__item
