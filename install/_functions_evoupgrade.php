...
// fp> TMP NOTE: This was current status of antispam
	...
	if( upg_task_start( 12310, 'Upgrading table for item user data...' ) )
	{	// part of 6.9.2-beta
		$DB->query( 'ALTER TABLE T_items__user_data
			ADD itud_read_item_mts     DOUBLE(13,3) UNSIGNED NOT NULL DEFAULT 0,
			ADD itud_read_comments_mts DOUBLE(13,3) UNSIGNED NOT NULL DEFAULT 0' );
		$DB->query( 'UPDATE T_items__user_data SET
			itud_read_item_mts     = UNIX_TIMESTAMP( itud_read_item_ts ),
			itud_read_comments_mts = UNIX_TIMESTAMP( itud_read_comments_ts )' );
		$DB->query( 'ALTER TABLE T_items__user_data
			DROP COLUMN itud_read_item_ts,
			DROP COLUMN itud_read_comments_ts' );
		upg_task_end();
	}

	if( upg_task_start( 12320, 'Upgrade table posts...' ) )
	{	// part of 6.9.2-beta
	...
	if( upg_task_start( 12330, 'Upgrade table comments...' ) )
	{	// part of 6.9.2-beta
