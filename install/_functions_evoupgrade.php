...
// fp> TMP NOTE: This was current status of antispam
	...
	if( upg_task_start( 12310, 'Upgrade items and item types tables to support short title...' ) )
	{	// part of 6.9.2-beta
		db_add_col( 'T_items__item', 'post_short_title', 'VARCHAR(50) NULL AFTER post_excerpt_autogenerated' );
		db_add_col( 'T_items__type', 'ityp_use_short_title', 'TINYINT DEFAULT 0 AFTER ityp_instruction' );
		upg_task_end();
	}
