...
// fp> TMP NOTE: This was current status of antispam
	...
	if( upg_task_start( 18020, 'Upgrading post types table...' ) )
	{	// part of 7.3.0-beta
		db_add_col( 'T_items__type', 'ityp_allow_resolving_comments', 'TINYINT DEFAULT 0 AFTER ityp_use_comment_expiration' );
		upg_task_end();
	}

	if( upg_task_start( 18030, 'Upgrading posts table...' ) )
	{	// part of 7.3.0-beta
		db_add_col( 'T_items__item', 'post_resolved_cmt_ID', 'INT UNSIGNED NULL' );
		upg_task_end();
	}
