...
class CollectionSettings extends AbstractSettings
{
	...
	var $_defaults = array(
		...
		// General settings:
			...
			'allow_subscriptions' => 0,         // Don't allow email subscriptions for new post by default
			'allow_comment_subscriptions' => 0, // Don't allow email subscriptions for new comment by default
