...
class CollectionSettings extends AbstractSettings
{
	...
	var $_defaults = array(
		...
		// General settings:
			...
			'allow_subscriptions' => 1,         // Don't allow email subscriptions for new post by default
			'allow_comment_subscriptions' => 1, // Don't allow email subscriptions for new comment by default
			'allow_item_subscriptions' => 1,    // Don't allow email subscriptions for a specific post by default
