...
$schema_queries = array_merge( $schema_queries, array(
	...
	'T_items__item' => array(
		...
		"CREATE TABLE T_items__item (
			...
			post_title                  VARCHAR(255) COLLATE utf8mb4_unicode_ci NOT NULL,"/* Do NOT change this field back to TEXT without a very good reason. */."
	...
	'T_items__type' => array(
		...
		"CREATE TABLE T_items__type (
			...
			ityp_schema            ENUM( 'Article', 'WebPage', 'BlogPosting', 'ImageGallery', 'DiscussionForumPosting', 'TechArticle', 'Product' ) COLLATE ascii_general_ci NULL DEFAULT NULL,
