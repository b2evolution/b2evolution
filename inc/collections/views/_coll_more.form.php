...
$Form->begin_fieldset( T_('Subscriptions').get_manual_link( 'subscriptions-other' ) );
	...
	$subscription_checkboxes[] = array( 'allow_subscriptions', 1, T_('Allow users to subscribe and receive email notifications for each new post and/or comment.'), $allow_subscriptions );
...
<script type="text/javascript">
	var advancedPerms = <?php $advanced_perms;?>;
