...
Admins and moderators can very quickly approve or reject comments from the collection dashboard.');
	...
	$DB->query( 'INSERT INTO T_comments( comment_item_ID, comment_status,
			...
			comment_date, comment_last_touched_mts, comment_content, comment_renderers, comment_notif_status, comment_notif_flags )
			...
			.$DB->quote( $now ).', '.$DB->quote( $now_mts ).', '.$DB->quote( $content ).', "default", "finished", "moderators_notified,members_notified,community_notified" )' );
}
