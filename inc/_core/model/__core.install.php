...
$schema_queries = array(
	...
	'T_users' => array(
		...
		"CREATE TABLE T_users (
			...
			user_firstname varchar(50) COLLATE utf8mb4_unicode_ci NULL,
			user_lastname varchar(50) COLLATE utf8mb4_unicode_ci NULL,
			user_nickname varchar(50) COLLATE utf8mb4_unicode_ci NULL,
	...
	'T_locales' => array(
		...
		"CREATE TABLE T_locales (
			...
			loc_name varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL default '',
			loc_messages varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL default '',
			loc_priority tinyint(4) UNSIGNED NOT NULL default '0',
			loc_transliteration_map varchar(10000) COLLATE utf8mb4_unicode_ci NOT NULL default '',
	...
	'T_plugins' => array(
		...
		"CREATE TABLE T_plugins (
			...
			plug_name            VARCHAR(255) COLLATE utf8mb4_unicode_ci NULL default NULL,
			plug_shortdesc       VARCHAR(255) COLLATE utf8mb4_unicode_ci NULL default NULL,
	...
	'T_regional__region' => array(
		...
		"CREATE TABLE T_regional__region (
			...
			rgn_name      varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
	...
	'T_regional__subregion' => array(
		...
		"CREATE TABLE T_regional__subregion (
			...
			subrg_name      varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
	...
	'T_email__log' => array(
		...
		"CREATE TABLE T_email__log (
			...
			emlog_subject       VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			emlog_headers       TEXT COLLATE utf8mb4_unicode_ci DEFAULT NULL,
	...
	'T_email__returns' => array(
		...
		"CREATE TABLE T_email__returns (
			...
			emret_headers   TEXT COLLATE utf8mb4_unicode_ci DEFAULT NULL,
	...
	'T_email__campaign' => array(
		...
		"CREATE TABLE T_email__campaign (
			...
			ecmp_user_tag_cta1        VARCHAR(255) COLLATE utf8mb4_unicode_ci NULL,
			ecmp_user_tag_cta2        VARCHAR(255) COLLATE utf8mb4_unicode_ci NULL,
			...
			ecmp_user_tag_activate    VARCHAR(255) COLLATE utf8mb4_unicode_ci NULL,
