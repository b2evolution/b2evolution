...
class Chapter extends DataObject
{
	...
	function load_from_request()
	{
		...
		// Set slugs:
		$this->new_slugs = param( 'cat_urlname', 'string' );
	...
	function dbinsert()
	{
		...
		$this->set( 'urlname', urltitle_validate( '', $this->get( 'name' ), $this->ID, false, 'slug_title', 'slug_cat_ID', 'T_slug' ) );
		...
		{	// The chapter was inserted successful
			...
			{	// Use autogenerated slug title if new slugs have not been entered on the submitted form:
				$this->new_slugs = $this->get( 'urlname' );
			}
	...
	function update_slugs()
	{
		...
		foreach( $new_slugs as $new_slug_title )
		{
			...
			{	// Update canonical slug of this Chapter:
				$this->set( 'urlname', $cat_Slug->get( 'title' ) );
