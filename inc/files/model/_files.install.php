...
$schema_queries['T_files'] = array(
		...
		"CREATE TABLE T_files (
			...
			file_root_type           enum('absolute','user','collection','shared','skins','siteskins','plugins','import','export','emailcampaign') COLLATE ascii_general_ci NOT NULL DEFAULT 'absolute',
