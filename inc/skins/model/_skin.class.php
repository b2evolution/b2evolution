...
class Skin extends DataObject
{
	...
	function get_style( $setting_name, $style_template, $params = array() )
	{
		$params = array_merge( array(
				...
				'function' => NULL, // Function which should be apply to the value on each update by customzer JS code, e.g. 'rgba'
			), $params );
		...
		{	// If customizer mode enabled we should append a special css comment code
			...
			{	// Value is generated by special function:
				$setting_options .= '/function:'.$params['function'];
			}
