...
class GeneralSettings extends AbstractSettings
{
	...
	var $_defaults = array(
		...
		'account_new_notifications_mode' => 'cron',
		'account_activate_notifications_mode' => 'immediate',
		'account_activated_notifications_mode' => 'cron',
		'account_password_reset_notifications_mode' => 'immediate',
		'account_changed_notifications_mode' => 'cron',
		'account_reported_notifications_mode' => 'cron',
		'account_closed_notifications_mode' => 'cron',
		'private_message_new_notifications_mode' => 'cron',
		'contact_message_new_notifications_mode' => 'cron',
		'post_assignment_notifications_mode' => 'cron',
		//'post_by_email_report_notifications_mode' => 'immediate',
		'comment_spam_notifications_mode' => 'cron',
		'scheduled_task_error_report_notifications_mode' => 'cron',
		'automation_owner_notification_notifications_mode' => 'cron',
		'newsletter_test_notifications_mode' => 'cron',
