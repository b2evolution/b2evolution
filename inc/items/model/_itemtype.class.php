...
class ItemType extends DataObject
{
	...
	function dbsave_custom_fields()
	{
		...
		{	// Insert new custom fields:
			...
			$DB->query( 'INSERT INTO T_items__type_custom_field ( itcf_ityp_ID, itcf_label, itcf_name, itcf_type, itcf_order, itcf_note, itcf_public, itcf_format, itcf_formula, itcf_cell_class, itcf_link, itcf_link_class, itcf_line_highlight, itcf_green_highlight, itcf_red_highlight, itcf_description )
