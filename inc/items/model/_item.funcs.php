...
function load_user_data_for_items( $post_ids = NULL )
{
	...
	$SQL->SELECT( 'itud_item_ID AS item_ID, IFNULL( itud_read_item_mts, 0 ) AS item_date, IFNULL( itud_read_comments_mts, 0 )AS comments_date, itud_flagged_item AS item_flag' );
