		...
		switch( $parname )
		{
			...
			case 'excerpt':
				...
				{	// Up to now, exceprt was auto-generated
					// Check if the excerpt needs to cotninue being autogenerated...
...
// fp> here we should first detect if except has really changed or if it is the same before saying it has changed
			return true;
		}
