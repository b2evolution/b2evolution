	...
	function set( $parname, $parvalue, $make_null = false )
	{
		switch( $parname )
		{
			...
			case 'excerpt':
				...
				{	// Up to now, excerpt was auto-generated,
					// Check if the excerpt needs to continue being autogenerated:
					if( $this->excerpt == $parvalue || empty( $parvalue ) )
					{	// We have submitted an unmodified excerpt, so we will continue to autogenerate.
						// Additionnally, we may have changed the content of the post, so we want to regenerate an up-to-date except that matches the new content now:
						$parvalue = $this->get_autogenerated_excerpt();
					}
					else
					{	// The excerpt has been edited manually, stop autogenerating in the future:
						$this->set( 'excerpt_autogenerated', 0 );
					}
				}
...
// fp> maybe the above if is already correct
	 ...
	 * was: Quick and dirty "excerpts should not stay empty".
	 *
	...
	{
		// Clear prerendered content to generate excert from new content:
		$this->delete_prerendered_content();
