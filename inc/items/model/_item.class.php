...
// NOTE: if the new excerpt is empty, set() will switch back to autogeneration:
	 ...
	 * @param boolean DEPRECATED: Update excerpt? - We want to PREVENT updating exerpts when the item content wasn't changed ( e.g. only item canonical slug was changed )
	 * @return boolean true on success
	 */
	...
	/**
	 * Update ONLY autogenerated excerpt
	 *
	...
	function update_autogenerated_excerpt()
	{
		...
		{	// As far as we know, we are still auto-generating excerpts for this Item at this moment, 
			...
			if( empty( $this->ID ) )
			{	// Save this in DB for new creating item:
				$this->set( 'excerpt_autogenerated', '1' );
			}
		}
	}
