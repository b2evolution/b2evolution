	...
	default:
		...
		switch( $user_tab )
		{
			...
			case 'activity':
				...
				if( in_array( $action, array( 'delete_all_sent_emails', 'delete_all_blogs', 'delete_all_posts_created', 'delete_all_posts_edited', 'delete_all_comments', 'delete_all_messages', 'delete_all_polls', 'delete_all_userdata' ) ) )
