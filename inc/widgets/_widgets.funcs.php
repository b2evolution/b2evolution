...
function get_default_widgets( $coll_type = '', $context = array() )
{
	...
	$default_widgets['item_single'] = array(
		...
		array(  7, 15190, 'item_title', 'coll_type' => 'manual,catalog' ),
		array(  8, 16170, 'subcontainer_row', 'coll_type' => 'catalog', 'params' => array(
				'column1_container' => 'coll:product_page_column_a',
				'column1_class'     => ( 'col-sm-6 col-xs-12' ),
				'column2_container' => 'coll:product_page_column_b',
				'column2_class'     => 'col-sm-6 col-xs-12',
				'widget_css_class'  => 'widget_core_subcontainer_row product_info',
			) ),
		array( 10, 15000, 'item_content' ),
		array( 11, 16170, 'item_custom_fields', 'coll_type' => 'catalog', 'params' => array( 'fields_source' => 'exclude', 'fields' => 'price', 'widget_css_class' => 'product_datasheet' ) ),
		array( 15, 15000, 'item_attachments', 'coll_type' => '-manual' ),
		array( 17, 15000, 'item_link', 'coll_type' => '-manual,catalog' ),
		array( 18, 15000, 'item_workflow', 'coll_type' => 'photo' ),
		array( 20, 15000, 'item_tags', 'coll_type' => '-forum,group,manual,catalog', 'install' => ! $context['init_as_blog_a'] && ! $context['init_as_events'] ),
		...
		array( 50, 15000, 'item_seen_by', 'coll_type' => '-forum,group,manual,catalog' ),
		array( 60, 15000, 'item_vote', 'coll_type' => '-forum,group,manual,catalog' ),
	);

	/* Product Page Column A */
	$default_widgets['product_page_column_a'] = array(
		'type'  => 'sub',
		'name'  => NT_('Product Page Column A'),
		'order' => 1,
		'coll_type' => 'catalog',
		array( 10, 16170, 'item_images', 'params' => array( 'display_type' => 'cover_with_fallback', 'image_limit' => 1, 'image_size' => 'fit-480x600', 'widget_css_class' => 'main_product_image' ) ),
		array( 20, 16170, 'item_images', 'params' => array( 'display_type' => 'cover', 'invert_display_type' => 1, 'image_limit' => 20, 'image_size' => 'fit-80x80', 'widget_css_class' => 'product_image_gallery' ) ),
	);

	/* Product Page Column B */
	$default_widgets['product_page_column_b'] = array(
		'type'  => 'sub',
		'name'  => NT_('Product Page Column B'),
		'order' => 2,
		'coll_type' => 'catalog',
		array(  5, 16170, 'item_excerpt' ),
		array( 10, 16170, 'item_tags' ),
		array( 15, 16170, 'item_vote' ),
		//array( 20, 'item_custom_fields', 'params' => array( 'fields_source' => 'include', 'fields' => 'price', 'widget_css_class' => 'product_price' ) ),
		array( 20, 16170, 'item_price' ),
		array( 25, 16170, 'item_availability' ),
		array( 30, 16170, 'add_to_cart_btn' ),
	);
	...
	$default_widgets['page_top'] = array(
		...
		array( 30, 16170, 'basic_menu_link', 'coll_type' => 'catalog', 'params' => array( 'link_type' => 'cart' ) ),
	);
	...
	else
	{
		...
		$default_widgets['sidebar'] = array(
			array(  5, 15000, 'coll_current_filters', 'coll_type' => '-forum,catalog', 'install' => $context['install_test_features'] ),
			array( 10, 15000, 'user_login', 'coll_type' => '-catalog', 'install' => $context['install_test_features'] ),
			array( 15, 15000, 'user_greetings', 'coll_type' => '-catalog', 'install' => $context['install_test_features'] ),
			array( 20, 15000, 'user_profile_pics', 'coll_type' => '-catalog', 'install' => $install_not_forum ),
			array( 30, 15000, 'evo_Calr', 'type' => 'plugin', 'coll_type' => '-catalog', 'install' => ( $install_not_forum && $context['current_coll_ID'] > $context['coll_blog_a_ID'] ) ),
			array( $coll_type == 'catalog' ? 60 : 40, 15000, 'coll_longdesc', 'install' => $install_not_forum, 'params' => array( 'title' => '$title$' ) ),
			array( $coll_type == 'catalog' ? 40 : 50, 15000, 'coll_search_form', 'install' => $install_not_forum, 'params' => array( 'template' => 'search_form_simple' ) ),
			array( $coll_type == 'catalog' ? 50 : 60, 15000, 'coll_category_list', 'install' => $install_not_forum ),
			...
			array( 80, 15000, 'coll_media_index', 'coll_type' => '-catalog', 'install' => ( $install_not_forum && ! $context['init_as_blog_b'] ), 'params' => array(
					'title'        => 'Random photo',
			...
			array( 100, 15000, 'coll_xml_feeds', 'coll_type' => '-catalog' ),
			array( 110, 15000, 'mobile_skin_switcher', 'coll_type' => '-catalog' ),
		);
	}
	...
	$default_widgets['shopping_cart'] = array(
		'coll_type' => 'catalog',
		array( 10, 16170, 'currency_selector' ),
		array( 20, 16170, 'display_shopping_cart' ),
		array( 30, 16170, 'country_selector' ),
		array( 40, 16170, 'display_shipping_method' ),
		array( 50, 16170, 'payment_stripe', 'type' => 'plugin' ),
	);
