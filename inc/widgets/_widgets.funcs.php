...
function get_default_widgets( $kind = '', $blog_id = NULL, $initial_install = false )
{
	...
	$default_widgets['item_single'] = array(
		...
		array( 11, 'item_custom_fields', 'coll_type' => 'catalog', 'params' => array( 'fields_source' => 'exclude', 'fields' => 'price', 'widget_css_class' => 'product_datasheet' ) ),
		array( 15, 'item_attachments' ),
		array( 17, 'item_link', 'coll_type' => '-catalog' ),
		array( 20, 'item_tags', 'coll_type' => '-forum,group,catalog', 'coll_ID' => '-'.$blog_a_ID.','.$events_blog_ID ),
		...
		array( 50, 'item_seen_by', 'coll_type' => '-forum,group,catalog' ),
		array( 60, 'item_vote', 'coll_type' => '-forum,catalog' ),
	);
	...
	$default_widgets['product_page_column_a'] = array(
		...
		'order' => 1,
		'coll_type' => 'catalog',
		array( 10, 'item_images', 'params' => array( 'display_type' => 'cover_with_fallback', 'image_limit' => 1, 'image_size' => 'fit-480x600', 'widget_css_class' => 'main_product_image' ) ),
		array( 20, 'item_images', 'params' => array( 'display_type' => 'cover', 'invert_display_type' => 1, 'image_limit' => 20, 'image_size' => 'fit-80x80', 'widget_css_class' => 'product_image_gallery' ) ),
	);
	...
	$default_widgets['page_top'] = array(
		...
		array( 30, 'basic_menu_link', 'coll_type' => 'catalog', 'params' => array( 'link_type' => 'cart' ) ),
	);
