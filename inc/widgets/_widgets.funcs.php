...
function get_default_widgets( $kind = '', $blog_id = NULL, $initial_install = false )
{
	...
	$default_widgets['item_single'] = array(
		...
		array( 11, 'item_custom_fields', 'coll_type' => 'catalog', 'params' => array( 'fields_source' => 'exclude', 'fields' => 'price_usd', 'widget_css_class' => 'product_datasheet' ) ),
	...
	$default_widgets['product_page_column_b'] = array(
		...
		array( 10, 'item_tags' ),
		array( 15, 'item_vote' ),
		array( 20, 'item_custom_fields', 'params' => array( 'fields_source' => 'include', 'fields' => 'price_usd', 'widget_css_class' => 'product_price' ) ),
