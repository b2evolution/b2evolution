...
class ComponentWidget extends DataObject
{
	...
	*/
	 ...
	 *
	 * @param string Default value for form display: 'standard', 'compact', 'nolabels'
	 * @return string Current form display: 'standard', 'compact', 'nolabels' or another default of the widget
	 */
	function get_form_display( $default_form_display = 'standard' )
	{
		...
		return in_array( $form_display, array( 'standard', 'compact', 'nolabels' ) ) ? $form_display : $default_form_display;
	}
}
?>