 ...
 *  - 'all_collections_and_redirected_posts' ( Default ): Allow redirects to a different domain only in case of all collection domains or posts with redirected status
