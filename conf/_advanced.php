...
$library_local_urls = array(
		'#jquery#' => array( 'jquery/jquery.min.js', 'jquery/jquery.js' ),
...
#		'#jqueryUI_css#' => array( 'jquery/smoothness/jquery-ui.css' ),
		'#bootstrap#' => array( 'bootstrap/js/bootstrap.min.js', 'bootstrap/js/bootstrap.js' ),
		'#bootstrap_css#' => array( 'bootstrap/css/bootstrap.min.css', 'bootstrap/css/bootstrap.css' ),
		'#bootstrap_theme_css#' => array( 'bootstrap/css/bootstrap-theme.min.css', 'bootstrap/css/bootstrap-theme.css' ),
		'#bootstrap_typeahead#' => array( 'bootstrap/js/typeahead.bundle.min.js', 'bootstrap/js/typeahead.bundle.js' ),
		...
		'#jqplot#' => array( 'jquery/jqplot/js/jquery.jqplot.min.js' ),
		'#jqplot_barRenderer#' => array( 'jquery/jqplot/js/jqplot.barRenderer.min.js' ),
		'#jqplot_canvasAxisTickRenderer#' => array( 'jquery/jqplot/js/jqplot.canvasAxisTickRenderer.min.js' ),
		'#jqplot_canvasTextRenderer#' => array( 'jquery/jqplot/js/jqplot.canvasTextRenderer.min.js' ),
		'#jqplot_categoryAxisRenderer#' => array( 'jquery/jqplot/js/jqplot.categoryAxisRenderer.min.js' ),
		'#jqplot_enhancedLegendRenderer#' => array( 'jquery/jqplot/js/jqplot.enhancedLegendRenderer.min.js' ),
		'#jqplot_highlighter#' => array( 'jquery/jqplot/js/jqplot.highlighter.min.js' ),
		'#jqplot_canvasOverlay#' => array( 'jquery/jqplot/js/jqplot.canvasOverlay.min.js' ),
		'#jqplot_donutRenderer#' => array( 'jquery/jqplot/js/jqplot.donutRenderer.min.js' ),
		'#jqplot_css#' => array( 'jquery/jqplot/css/jquery.jqplot.min.css', 'jquery/jqplot/css/jquery.jqplot.css' ),
		...
		'#mediaelement#' => array( 'mediaelement/js/mediaelement-and-player.min.js', 'mediaelement/js/mediaelement-and-player.js' ),
		'#mediaelement_css#' => array( 'mediaelement/css/mediaelementplayer.min.css', 'mediaelement/css/mediaelementplayer.css' ),
		'#videojs#' => array( 'videojs/js/video.min.js', 'videojs/js/video.js' ),
		'#videojs_css#' => array( 'videojs/css/video-js.min.css', 'videojs/css/video-js.css' ),
		'#jcrop#' => array( 'jquery/jcrop/js/jquery.jcrop.min.js', 'jquery/jcrop/js/jquery.jcrop.js' ),
		'#jcrop_css#' => array( 'jquery/jcrop/css/jquery.jcrop.min.css', 'jquery/jcrop/css/jquery.jcrop.css' ),
	);
