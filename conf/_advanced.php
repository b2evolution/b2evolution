...
$library_local_urls = array(
		'#jquery#' => array( 'ext/jquery.min.js', 'ext/jquery.js' ),
		'#jqueryUI#' => array( 'ext/jquery/jquery.ui.b2evo.min.js', 'ext/jquery/jquery.ui.b2evo.js' ),
		'#jqueryUI_css#' => array( 'ext/jquery/smoothness/jquery-ui.b2evo.min.css', 'ext/jquery/smoothness/jquery-ui.b2evo.css' ),
# Uncomment the following lines if your plugins need more jQueryUI features than the ones loaded by b2evo:
#		'#jqueryUI#' => array( 'ext/jquery/jquery.ui.all.min.js', 'ext/jquery/jquery.ui.all.js' ),
#		'#jqueryUI_css#' => array( 'ext/jquery/smoothness/jquery-ui.css' ),
		'#bootstrap#' => array( 'ext/bootstrap/bootstrap.min.js', 'ext/bootstrap/bootstrap.js' ),
		'#bootstrap_css#' => array( 'ext/bootstrap/bootstrap.min.css', 'ext/bootstrap/bootstrap.css' ),
		'#bootstrap_theme_css#' => array( 'ext/bootstrap/bootstrap-theme.min.css', 'ext/bootstrap/bootstrap-theme.css' ),
		'#bootstrap_typeahead#' => array( 'ext/bootstrap/typeahead.bundle.min.js', 'ext/bootstrap/typeahead.bundle.js' ),
		'#easypiechart#' => array( 'ext/jquery/jquery.easy-pie-chart.min.js', 'ext/jquery/jquery.easy-pie-chart.js' ),
		'#scrollto#' => array( 'jquery/jquery.scrollto.min.js', 'jquery/jquery.scrollto.js' ),
		'#touchswipe#' => array( 'ext/jquery/jquery.touchswipe.min.js', 'ext/jquery/jquery.touchswipe.js' ),
		'#jqplot#' => array( 'ext/jquery/jqplot/jquery.jqplot.min.js' ),
		'#jqplot_barRenderer#' => array( 'ext/jquery/jqplot/jqplot.barRenderer.min.js' ),
		'#jqplot_canvasAxisTickRenderer#' => array( 'ext/jquery/jqplot/jqplot.canvasAxisTickRenderer.min.js' ),
		'#jqplot_canvasTextRenderer#' => array( 'ext/jquery/jqplot/jqplot.canvasTextRenderer.min.js' ),
		'#jqplot_categoryAxisRenderer#' => array( 'ext/jquery/jqplot/jqplot.categoryAxisRenderer.min.js' ),
		'#jqplot_enhancedLegendRenderer#' => array( 'ext/jquery/jqplot/jqplot.enhancedLegendRenderer.min.js' ),
		'#jqplot_highlighter#' => array( 'ext/jquery/jqplot/jqplot.highlighter.min.js' ),
		'#jqplot_canvasOverlay#' => array( 'ext/jquery/jqplot/jqplot.canvasOverlay.min.js' ),
		'#jqplot_donutRenderer#' => array( 'ext/jquery/jqplot/jqplot.donutRenderer.min.js' ),
		'#jqplot_css#' => array( 'jquery/jquery.jqplot.min.css', 'jquery/jquery.jqplot.css' ),
		'#tinymce#' => array( 'ext/tiny_mce/tinymce.min.js' ),
		'#tinymce_gzip#' => array( 'ext/tiny_mce/tinymce.gzip.js' ),
		'#flowplayer#' => array( 'ext/flowplayer/flowplayer.min.js', 'ext/flowplayer/flowplayer.js' ),
		'#mediaelement#' => array( 'ext/mediaelement/mediaelement-and-player.min.js', 'ext/mediaelement/mediaelement-and-player.js' ),
		'#mediaelement_css#' => array( 'ext/mediaelement/mediaelementplayer.min.css', 'ext/mediaelement/mediaelementplayer.css' ),
		'#videojs#' => array( 'ext/videojs/video.min.js', 'ext/videojs/video.js' ),
		'#videojs_css#' => array( 'ext/videojs/video-js.min.css', 'ext/videojs/video-js.css' ),
		'#jcrop#' => array( 'ext/jquery/jquery.jcrop.min.js', 'ext/jquery/jquery.jcrop.js' ),
		'#jcrop_css#' => array( 'ext/jquery/jcrop/jquery.jcrop.min.css', 'ext/jquery/jcrop/jquery.jcrop.css' ),
	);
