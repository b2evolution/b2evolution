...
{ // Hit info
	...
	echo '<tr><th'.emailskin_style( 'table.email_table th' ).'>'.T_('Initial page').':</th><td'.emailskin_style( 'table.email_table td' ).'>'.T_('Collection')." ".$params['initial_hit']->hit_coll_ID." - ".get_link_tag( $params['initial_hit']->hit_uri, '', '.a', 60 ).'</td></tr>'."\n";
}
