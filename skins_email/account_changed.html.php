...
echo get_link_tag( $admin_url.'?ctrl=users&action=delete&deltype=spammer&user_ID='.$params['user_ID'].'&'.url_crumb('user'), T_('Delete Spammer'), 'div.buttons a+a.btn-danger' )."\n";
echo "</div>\n";
