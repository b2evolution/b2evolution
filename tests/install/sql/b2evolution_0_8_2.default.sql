...
INSERT INTO `{{{EVO_TABLE_PREFIX}}}blogs` VALUES (1, 'All', 'All Blogs', 'Tagline for All', 'All blogs on this system.', '', 'fr', 'http://localhost/blogs', 'blog_all.php', 'blog_all.html', 'blog_all.php', 'This is the blogroll for the ''all blogs'' blog aggregation.', 'all blogs keywords', 'standard', '');
INSERT INTO `{{{EVO_TABLE_PREFIX}}}blogs` VALUES (2, 'Blog A', 'Demo Blog A', 'Tagline for A', 'This is demo blog A', 'This is description for demo blog A. It has index #2 in the database.', 'fr', 'http://localhost/blogs', 'blog_a.php', 'blog_a.html', 'blog_a.php', 'This is the blogroll for Blog A...', 'blog A keywords', 'standard', '');
INSERT INTO `{{{EVO_TABLE_PREFIX}}}blogs` VALUES (3, 'Blog B', 'Demo Blog B', 'Tagline for B', 'This is demo blog B', 'This is description for demo blog B. It has index #3 in the database.', 'fr', 'http://localhost/blogs', 'blog_b.php', 'blog_b.html', 'blog_b.php', 'This is the blogroll for Blog B...', 'blog B keywords', 'standard', '');
INSERT INTO `{{{EVO_TABLE_PREFIX}}}blogs` VALUES (4, 'Blogroll', 'Demo Blogroll', 'Tagline for Blogroll', 'This is the demo blogroll', 'This is description for blogroll. It has index #4 in the database.', 'fr', 'http://localhost/blogs', 'blog_roll.php', 'blog_roll.html', 'blog_roll.php', 'This is the blogroll for the blogroll... pretty funky huh? :))', 'blogroll keywords', 'standard', '');
...
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (1, NULL, 'Announcements [A]', 2);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (2, NULL, 'News', 2);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (3, NULL, 'Background', 2);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (4, NULL, 'Announcements [B]', 3);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (5, NULL, 'Fun', 3);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (6, 5, 'In real life', 3);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (7, 5, 'On the web', 3);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (8, 6, 'Sports', 3);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (9, 6, 'Movies', 3);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (10, 6, 'Music', 3);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (11, NULL, 'b2evolution', 3);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (12, NULL, 'b2evolution', 4);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}categories` VALUES (13, NULL, 'contributors', 4);
...
INSERT INTO `{{{EVO_TABLE_PREFIX}}}comments` VALUES (1, 1, 'comment', 'published', 'miss b2', 'missb2@example.com', 'http://example.com', '127.0.0.1', '2006-02-24 18:52:00', 'Hi, this is a comment.<br />To delete a comment, just log in, and view the posts'' comments, there you will have the option to edit or delete them.', 0);
...
INSERT INTO `{{{EVO_TABLE_PREFIX}}}postcats` VALUES (4, 9);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}postcats` VALUES (5, 11);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}postcats` VALUES (6, 11);
...
INSERT INTO `{{{EVO_TABLE_PREFIX}}}postcats` VALUES (11, 13);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}postcats` VALUES (12, 13);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}postcats` VALUES (13, 13);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}postcats` VALUES (14, 12);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}postcats` VALUES (15, 12);
...
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (1, 1, '2006-02-24 18:52:00', 'published', 'en', '<p>This is the first post.</p>\r\n		\r\n		<p>It appears on both blog A and blog B.</p>', 'First Post', 1, '', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (2, 1, '2006-02-24 18:52:01', 'published', 'en', '<p>This is the second post.</p>\r\n		\r\n		<p>It appears on blog A only but in multiple categories.</p>', 'Second post', 2, '', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (3, 1, '2006-02-24 18:52:02', 'published', 'en', '<p>This is the third post.</p>\r\n		\r\n		<p>It appears on blog B only and in a single category.</p>', 'Third post', 5, '', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (4, 1, '2006-02-24 18:52:03', 'published', 'en', '<p>Wait until the end of the super long end credits!</p>\r\n		\r\n		<p>If you''re patient enough, you''ll a get preview of the next episode...</p>\r\n		\r\n		<p>Though... it''s just the same anyway! :>></p>', 'Matrix Reloaded', 9, '', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (5, 1, '2006-02-24 18:52:04', 'published', 'en', '<p>b2evolution uses old-style permalinks and feedback links by default. This is to ensure maximum compatibility with various webserver configurations. Nethertheless, if you feel comfortable, you should try activating clean permalinks in the /conf/b2{{{EVO_TABLE_PREFIX}}}advanced.php file...</p>', 'Clean Permalinks! :idea:', 11, '', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (6, 1, '2006-02-24 18:52:05', 'published', 'en', '<p>By default, b2evolution blogs are displayed in the \\''standard\\'' skin.</p>\r\n\r\n<p>Readers can choose a new skin by using the skin switcher integrated in most skins.</p>		\r\n\r\n<p>You can restrict available skins by deleting some of them from the /blogs/skins folder. You can also change the default skin or force a specific skin. <strong>Actually, you should change the default skin and delete the standard skin, as this one has navigation links at the top that are only good for the sake of the demo. These would be a nonsense on production servers!</strong> Read the manual on evoSkins!</p>', 'Clean Skin! :idea:', 11, '', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (7, 1, '2006-02-24 18:52:06', 'published', 'en', 'Main dev', 'François', 13, 'http://fplanque.net/Blog/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (8, 1, '2006-02-24 18:52:07', 'published', 'en', 'Testing', 'Candle', 13, 'http://www.candles-weblog.us/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (9, 1, '2006-02-24 18:52:08', 'published', 'en', 'Hacks, Testing', 'Ron', 13, 'http://www.rononline.nl/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (10, 1, '2006-02-24 18:52:09', 'published', 'en', 'evoSkins.org, Testing', 'Sabrina', 13, 'http://lifeisadiaper.com/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (11, 1, '2006-02-24 18:52:10', 'published', 'en', 'Testing', 'Graham', 13, 'http://www.teenangst.co.uk/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (12, 1, '2006-02-24 18:52:11', 'published', 'en', 'Testing', 'Topanga', 13, 'http://www.tenderfeelings.be/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (13, 1, '2006-02-24 18:52:12', 'published', 'en', 'Hosting', 'Brian', 13, 'http://www.memenethosting.com/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (14, 1, '2006-02-24 18:52:13', 'published', 'en', 'get more skins!', 'evoSkins.org', 12, 'http://www.evoskins.org/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
INSERT INTO `{{{EVO_TABLE_PREFIX}}}posts` VALUES (15, 1, '2006-02-24 18:52:14', 'published', 'en', 'Project home', 'b2evolution', 12, 'http://b2evolution.net/', 0, 'pingsdone,html,bbcode,gmcode,smileys', 0, NULL);
...
INSERT INTO `{{{EVO_TABLE_PREFIX}}}settings` VALUES (1, 3, 'paged', 'monthly', 0, 1, 'H:i:s', 'd.m.y', 8000);
...
INSERT INTO `{{{EVO_TABLE_PREFIX}}}users` VALUES (1, 'admin', '9cd9c1', '', '', 'admin', 0, 'postmaster@localhost', '', '127.0.0.1', '127.0.0.1', '', '2000-00-00 00:00:01', 10, '', '', '', 'nickname');
