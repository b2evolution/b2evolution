...
{
	$Messages->add_to_group( T_('Supplied URL is invalid: ').$error, 'error', T_('Validation error:') );
}
...
{ // comment should not be empty!
	$Messages->add_to_group( T_('Please do not send empty comment'), 'error', T_('Validation error:') );
}
