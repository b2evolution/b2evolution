...
echo '<div class="panel panel-default evo_content_block">';
	...
	echo '<div class="panel-body">';
		...
		$posted_Comment->author_email( '', ' &bull; Email: <span class="bEmail">', '</span> &bull; ' );
		...
		$user_permission = $current_User->check_perm( 'meta_comment', 'edit', false, $posted_Comment );
		if( $user_permission )
		...
		$posted_Comment->content( 'htmlbody', true );
		if( $user_permission )
