...
switch( $action )
{
	...
	case 'get_user_new_field':
		...
		$userfields = $DB->get_results( '
			SELECT ufdf_ID, "0" AS uf_ID, ufdf_type, ufdf_code, ufdf_name, ufdf_icon_name, "" AS uf_varchar, ufdf_required, ufdf_visibility, ufdf_options, ufdf_suggest, ufdf_duplicated, ufdf_grp_ID, ufgp_ID, ufgp_name, ufdf_ufgp_ID, ufdf_order, ufdf_bubbletip
