	...
	function get_template( $name, $depth = 0, $die_on_unknown = false )
	{
		switch( $name )
		{
			...
			case 'menu3':
				// level 3 submenu:
				return array(
						'before' => '<div class="container-fluid"><div class="row"><div class="col-md-6 level3">'."\n"
										.'<nav>'."\n"
									.'<ul class="nav nav-pills">'."\n",
						'after' => '</ul>'."\n"
									.'</nav>'."\n"
								.'</div>'."\n"
								.'<div class="col-md-6"><div class="pull-right">$global_icons$</div></div>'."\n"
								.'</div></div>'."\n",
						'empty' => '<div class="container-fluid"><div class="col-sm-12"><div>$global_icons$</div></div></div>',
						'beforeEach' => '<li role="presentation">',
						'afterEach'  => '</li>',
						'beforeEachSel' => '<li role="presentation" class="active">',
						'afterEachSel' => '</li>',
