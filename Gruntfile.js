		...
		uglify: {
			...
			*/
			...
			evo_frontoffice_bootstrap: {
				options: {
					banner: '/* This includes 12 files: build/evo_generic.bmin.js, src/bootstrap-evo_modal_window.js, src/evo_images.js, src/evo_user_crop.js, src/evo_user_report.js, src/evo_user_contact_groups.js, src/evo_rest_api.js, src/evo_message_options.js, src/evo_item_flag.js, src/evo_links.js, src/evo_forms.js, ajax.js */\n'
				},
				nonull: true, // Display missing files
				src: ['rsc/js/build/evo_generic.bmin.js',
			...
			evo_backoffice_bootstrap: {
				options: {
					banner: '/* This includes 24 files: build/evo_generic.bmin.js, functions.js, ajax.js, communication.js, form_extensions.js, extracats.js, dynamic_select.js, backoffice.js, '+
						...
						'src/evo_user_org.js, src/evo_automation.js, src/evo_user_tags.js, src/evo_user_status.js, src/evo_user_groups.js, src/evo_rest_api.js, src/evo_message_options.js, src/evo_links.js, src/evo_forms.js, src/evo_input_counter.js */\n'
				},
				nonull: true, // Display missing files
				src: ['rsc/js/build/evo_generic.bmin.js',
							'rsc/js/functions.js',
