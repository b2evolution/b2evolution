	...
	grunt.initConfig({
		...
		uglify: {
			...
			*/
			...
			evo_backoffice: {
				options: {
					banner: '/* This includes 12 files: functions.js, ajax.js, form_extensions.js, backoffice.js, extracats.js, '+
						'dynamic_select.js, src/evo_modal_window.js, src/evo_user_crop.js, src/evo_user_report.js, src/evo_user_deldata.js, '+
			...
			evo_backoffice_bootstrap: {
				options: {
					banner: '/* This includes 12 files: functions.js, ajax.js, form_extensions.js, backoffice.js, extracats.js, '+
						'dynamic_select.js, src/bootstrap-evo_modal_window.js, src/evo_user_crop.js, src/evo_user_report.js, '+
						'src/evo_user_deldata.js, src/evo_user_org.js, src/evo_rest_api.js, src/evo_links.js */\n'
				},
				nonull: true, // Display missing files
				src: ['rsc/js/functions.js',
							'rsc/js/ajax.js',
