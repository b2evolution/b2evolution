	...
	grunt.initConfig({
		...
		uglify: {
			...
			*/
			...
			bubbletip: {
				options: {
					banner: '/* This includes 4 files: bubbletip.js, tooltips.js, userfields.js, colorpicker.js */\n'
				},
				nonull: true, // Display missing files
				// fp>yura: why isn't jquery.bubbletip.js bundled into this?
				// if tooltips.js is used only for editing we should probably move it to a textedit.bundle
				src: ['rsc/js/bubbletip.js', 'rsc/js/tooltips.js', 'rsc/js/userfields.js', 'rsc/js/colorpicker.js'],
				dest: 'rsc/js/build/bubbletip.bmin.js'
			},
			// Popover (Analog of bubbletip on bootstrap skins)
			popover: {
				options: {
					banner: '/* This includes 5 files: bootstrap/usernames.js, bootstrap/tooltips.js, bootstrap/userfields.js, bootstrap/colorpicker.js, bootstrap/formfields.js */\n'
				},
				nonull: true, // Display missing files
				src: ['rsc/js/bootstrap/usernames.js', 'rsc/js/bootstrap/tooltips.js', 'rsc/js/bootstrap/userfields.js', 'rsc/js/bootstrap/colorpicker.js', 'rsc/js/bootstrap/formfields.js'],
