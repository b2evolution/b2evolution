		...
		uglify: {
			...
			*/
			...
			evo_frontoffice_bootstrap: {
				options: {
					banner: '/* This includes 10 files: src/bootstrap-evo_modal_window.js, src/evo_images.js, src/evo_user_crop.js, src/evo_user_report.js, src/evo_user_contact_groups.js, src/evo_rest_api.js, src/evo_message_options.js, src/evo_item_flag.js, src/evo_links.js, ajax.js */\n'
				},
				nonull: true, // Display missing files
			...
			evo_backoffice_bootstrap: {
				options: {
					banner: '/* This includes 16 files: functions.js, ajax.js, communication.js, form_extensions.js, backoffice.js, extracats.js, dynamic_select.js, '+
						...
						'src/evo_user_org.js, src/evo_rest_api.js, src/evo_message_options.js, src/evo_links.js */\n'
				},
				nonull: true, // Display missing files
				src: ['rsc/js/functions.js',
							'rsc/js/ajax.js',
